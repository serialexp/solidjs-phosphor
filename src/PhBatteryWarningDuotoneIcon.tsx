...
export interface PhBatteryWarningDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryWarningDuotoneIcon(props: PhBatteryWarningDuotoneIconProps) {
