...
export interface PhFileJsDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileJsDuotoneIcon(props: PhFileJsDuotoneIconProps) {
