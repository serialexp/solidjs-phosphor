...
export interface PhChatCenteredTextDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatCenteredTextDuotoneIcon(props: PhChatCenteredTextDuotoneIconProps) {
