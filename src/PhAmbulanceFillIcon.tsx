...
export interface PhAmbulanceFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmbulanceFillIcon(props: PhAmbulanceFillIconProps) {
