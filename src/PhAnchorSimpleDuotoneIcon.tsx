...
export interface PhAnchorSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAnchorSimpleDuotoneIcon(props: PhAnchorSimpleDuotoneIconProps) {
