...
export interface PhLineSegmentLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLineSegmentLightIcon(props: PhLineSegmentLightIconProps) {
