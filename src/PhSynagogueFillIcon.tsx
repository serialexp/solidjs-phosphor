...
export interface PhSynagogueFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSynagogueFillIcon(props: PhSynagogueFillIconProps) {
