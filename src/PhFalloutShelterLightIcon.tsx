...
export interface PhFalloutShelterLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFalloutShelterLightIcon(props: PhFalloutShelterLightIconProps) {
