...
export interface PhBuildingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBuildingDuotoneIcon(props: PhBuildingDuotoneIconProps) {
