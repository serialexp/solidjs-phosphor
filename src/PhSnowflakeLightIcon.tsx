...
export interface PhSnowflakeLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSnowflakeLightIcon(props: PhSnowflakeLightIconProps) {
