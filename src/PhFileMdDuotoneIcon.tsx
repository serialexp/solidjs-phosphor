...
export interface PhFileMdDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileMdDuotoneIcon(props: PhFileMdDuotoneIconProps) {
