...
export interface PhTerminalWindowIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTerminalWindowIcon(props: PhTerminalWindowIconProps) {
