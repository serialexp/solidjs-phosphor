...
export interface PhLightningAThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLightningAThinIcon(props: PhLightningAThinIconProps) {
