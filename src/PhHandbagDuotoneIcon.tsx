...
export interface PhHandbagDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandbagDuotoneIcon(props: PhHandbagDuotoneIconProps) {
