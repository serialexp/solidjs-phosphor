...
export interface PhTextAlignRightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextAlignRightIcon(props: PhTextAlignRightIconProps) {
