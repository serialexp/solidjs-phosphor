...
export interface PhVinylRecordDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVinylRecordDuotoneIcon(props: PhVinylRecordDuotoneIconProps) {
