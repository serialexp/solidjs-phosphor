...
export type { PhIconProps as PhGenderFemaleLightIconProps } from "./createIcon.js";
 ...
 */
export const PhGenderFemaleLightIcon = createIcon(`<path d="M206,96a78,78,0,1,0-84,77.75V202H88a6,6,0,0,0,0,12h34v26a6,6,0,0,0,12,0V214h34a6,6,0,0,0,0-12H134V173.75A78.09,78.09,0,0,0,206,96ZM62,96a66,66,0,1,1,66,66A66.08,66.08,0,0,1,62,96Z"/>`);
