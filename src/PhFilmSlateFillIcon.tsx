...
export interface PhFilmSlateFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmSlateFillIcon(props: PhFilmSlateFillIconProps) {
