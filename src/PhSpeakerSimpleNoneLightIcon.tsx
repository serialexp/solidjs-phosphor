...
export interface PhSpeakerSimpleNoneLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleNoneLightIcon(props: PhSpeakerSimpleNoneLightIconProps) {
