...
export interface PhCornersInLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCornersInLightIcon(props: PhCornersInLightIconProps) {
