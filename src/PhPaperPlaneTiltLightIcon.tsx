...
export interface PhPaperPlaneTiltLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneTiltLightIcon(props: PhPaperPlaneTiltLightIconProps) {
