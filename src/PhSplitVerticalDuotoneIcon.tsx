...
export interface PhSplitVerticalDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSplitVerticalDuotoneIcon(props: PhSplitVerticalDuotoneIconProps) {
