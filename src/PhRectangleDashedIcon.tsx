...
export interface PhRectangleDashedIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhRectangleDashedIcon(props: PhRectangleDashedIconProps) {
