...
export type { PhIconProps as PhMartiniLightIconProps } from "./createIcon.js";
 ...
 */
export const PhMartiniLightIcon = createIcon(`<path d="M236.24,44.24A6,6,0,0,0,232,34H24a6,6,0,0,0-4.24,10.24L122,146.49V210H88a6,6,0,0,0,0,12h80a6,6,0,0,0,0-12H134V146.49ZM70.49,78h115L128,135.51Zm147-32-20,20h-139l-20-20Z"/>`);
