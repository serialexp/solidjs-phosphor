...
export interface PhDiceTwoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiceTwoDuotoneIcon(props: PhDiceTwoDuotoneIconProps) {
