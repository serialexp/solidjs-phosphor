...
export interface PhArrowFatLineUpLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLineUpLightIcon(props: PhArrowFatLineUpLightIconProps) {
