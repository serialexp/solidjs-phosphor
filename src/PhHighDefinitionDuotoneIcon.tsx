...
export interface PhHighDefinitionDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHighDefinitionDuotoneIcon(props: PhHighDefinitionDuotoneIconProps) {
