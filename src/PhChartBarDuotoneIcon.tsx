...
export interface PhChartBarDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartBarDuotoneIcon(props: PhChartBarDuotoneIconProps) {
