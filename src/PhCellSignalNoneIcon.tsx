...
export interface PhCellSignalNoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalNoneIcon(props: PhCellSignalNoneIconProps) {
