...
export interface PhClosedCaptioningDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClosedCaptioningDuotoneIcon(props: PhClosedCaptioningDuotoneIconProps) {
