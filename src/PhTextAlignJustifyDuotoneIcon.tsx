...
export interface PhTextAlignJustifyDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextAlignJustifyDuotoneIcon(props: PhTextAlignJustifyDuotoneIconProps) {
