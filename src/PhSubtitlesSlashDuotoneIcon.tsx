...
export interface PhSubtitlesSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSubtitlesSlashDuotoneIcon(props: PhSubtitlesSlashDuotoneIconProps) {
