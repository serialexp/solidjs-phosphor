...
export interface PhNotificationFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNotificationFillIcon(props: PhNotificationFillIconProps) {
