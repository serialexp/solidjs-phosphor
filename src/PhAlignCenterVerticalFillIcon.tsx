...
export interface PhAlignCenterVerticalFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAlignCenterVerticalFillIcon(props: PhAlignCenterVerticalFillIconProps) {
