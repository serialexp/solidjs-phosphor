...
export interface PhSelectionSlashBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionSlashBoldIcon(props: PhSelectionSlashBoldIconProps) {
