...
export interface PhPerspectiveDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPerspectiveDuotoneIcon(props: PhPerspectiveDuotoneIconProps) {
