...
export interface PhPhoneListDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneListDuotoneIcon(props: PhPhoneListDuotoneIconProps) {
