...
export interface PhTrayArrowUpFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrayArrowUpFillIcon(props: PhTrayArrowUpFillIconProps) {
