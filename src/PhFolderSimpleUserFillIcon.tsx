...
export interface PhFolderSimpleUserFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleUserFillIcon(props: PhFolderSimpleUserFillIconProps) {
