...
export interface PhPhoneTransferDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneTransferDuotoneIcon(props: PhPhoneTransferDuotoneIconProps) {
