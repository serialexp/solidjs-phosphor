...
export interface PhWifiLowDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWifiLowDuotoneIcon(props: PhWifiLowDuotoneIconProps) {
