...
export interface PhPencilSimpleSlashIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPencilSimpleSlashIcon(props: PhPencilSimpleSlashIconProps) {
