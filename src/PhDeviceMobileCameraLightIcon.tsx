...
export interface PhDeviceMobileCameraLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDeviceMobileCameraLightIcon(props: PhDeviceMobileCameraLightIconProps) {
