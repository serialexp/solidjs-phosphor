...
export interface PhPresentationChartBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPresentationChartBoldIcon(props: PhPresentationChartBoldIconProps) {
