...
export interface PhFireExtinguisherIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFireExtinguisherIcon(props: PhFireExtinguisherIconProps) {
