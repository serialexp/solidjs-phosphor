...
export interface PhSupersetProperOfDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSupersetProperOfDuotoneIcon(props: PhSupersetProperOfDuotoneIconProps) {
