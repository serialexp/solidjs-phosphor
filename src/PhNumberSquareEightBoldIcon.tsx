...
export interface PhNumberSquareEightBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareEightBoldIcon(props: PhNumberSquareEightBoldIconProps) {
