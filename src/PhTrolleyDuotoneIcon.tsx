...
export interface PhTrolleyDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrolleyDuotoneIcon(props: PhTrolleyDuotoneIconProps) {
