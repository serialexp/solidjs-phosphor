...
export interface PhSpeakerSimpleXLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleXLightIcon(props: PhSpeakerSimpleXLightIconProps) {
