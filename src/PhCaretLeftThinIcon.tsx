...
export interface PhCaretLeftThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretLeftThinIcon(props: PhCaretLeftThinIconProps) {
