...
export interface PhFolderSimpleUserBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleUserBoldIcon(props: PhFolderSimpleUserBoldIconProps) {
