...
export interface PhHourglassLowThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassLowThinIcon(props: PhHourglassLowThinIconProps) {
