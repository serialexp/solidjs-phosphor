...
export interface PhCompassDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCompassDuotoneIcon(props: PhCompassDuotoneIconProps) {
