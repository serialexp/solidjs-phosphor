...
export interface PhPaperPlaneTiltBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneTiltBoldIcon(props: PhPaperPlaneTiltBoldIconProps) {
