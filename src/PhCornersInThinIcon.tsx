...
export interface PhCornersInThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCornersInThinIcon(props: PhCornersInThinIconProps) {
