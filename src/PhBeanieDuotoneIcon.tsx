...
export interface PhBeanieDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBeanieDuotoneIcon(props: PhBeanieDuotoneIconProps) {
