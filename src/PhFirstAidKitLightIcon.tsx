...
export interface PhFirstAidKitLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidKitLightIcon(props: PhFirstAidKitLightIconProps) {
