...
export interface PhAirplaneInFlightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneInFlightThinIcon(props: PhAirplaneInFlightThinIconProps) {
