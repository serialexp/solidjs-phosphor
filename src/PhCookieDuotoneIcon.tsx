...
export interface PhCookieDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCookieDuotoneIcon(props: PhCookieDuotoneIconProps) {
