...
export interface PhTrolleySuitcaseBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrolleySuitcaseBoldIcon(props: PhTrolleySuitcaseBoldIconProps) {
