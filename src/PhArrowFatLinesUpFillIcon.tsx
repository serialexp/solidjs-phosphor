...
export interface PhArrowFatLinesUpFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLinesUpFillIcon(props: PhArrowFatLinesUpFillIconProps) {
