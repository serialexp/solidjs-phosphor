...
export interface PhGenderIntersexDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGenderIntersexDuotoneIcon(props: PhGenderIntersexDuotoneIconProps) {
