...
export interface PhSnowflakeFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSnowflakeFillIcon(props: PhSnowflakeFillIconProps) {
