...
export interface PhMicrosoftOutlookLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrosoftOutlookLogoIcon(props: PhMicrosoftOutlookLogoIconProps) {
