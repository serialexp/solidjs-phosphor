...
export interface PhWashingMachineFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWashingMachineFillIcon(props: PhWashingMachineFillIconProps) {
