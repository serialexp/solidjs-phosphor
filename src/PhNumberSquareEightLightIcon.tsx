...
export interface PhNumberSquareEightLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareEightLightIcon(props: PhNumberSquareEightLightIconProps) {
