...
export interface PhSteeringWheelDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSteeringWheelDuotoneIcon(props: PhSteeringWheelDuotoneIconProps) {
