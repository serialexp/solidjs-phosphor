...
export interface PhMouseLeftClickIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMouseLeftClickIcon(props: PhMouseLeftClickIconProps) {
