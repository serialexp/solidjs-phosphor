...
export interface PhMapPinLineDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinLineDuotoneIcon(props: PhMapPinLineDuotoneIconProps) {
