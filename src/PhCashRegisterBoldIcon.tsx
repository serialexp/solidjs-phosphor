...
export interface PhCashRegisterBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCashRegisterBoldIcon(props: PhCashRegisterBoldIconProps) {
