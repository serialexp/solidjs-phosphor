...
export interface PhDotsThreeCircleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDotsThreeCircleDuotoneIcon(props: PhDotsThreeCircleDuotoneIconProps) {
