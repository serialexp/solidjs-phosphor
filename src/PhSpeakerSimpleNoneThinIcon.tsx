...
export interface PhSpeakerSimpleNoneThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleNoneThinIcon(props: PhSpeakerSimpleNoneThinIconProps) {
