...
export interface PhIntersectionDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectionDuotoneIcon(props: PhIntersectionDuotoneIconProps) {
