...
export interface PhSmileyAngryDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSmileyAngryDuotoneIcon(props: PhSmileyAngryDuotoneIconProps) {
