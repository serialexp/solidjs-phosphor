...
export interface PhNyTimesLogoLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNyTimesLogoLightIcon(props: PhNyTimesLogoLightIconProps) {
