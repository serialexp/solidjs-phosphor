...
export interface PhBookmarksSimpleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBookmarksSimpleThinIcon(props: PhBookmarksSimpleThinIconProps) {
