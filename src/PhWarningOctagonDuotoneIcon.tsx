...
export interface PhWarningOctagonDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWarningOctagonDuotoneIcon(props: PhWarningOctagonDuotoneIconProps) {
