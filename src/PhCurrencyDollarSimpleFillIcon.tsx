...
export interface PhCurrencyDollarSimpleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyDollarSimpleFillIcon(props: PhCurrencyDollarSimpleFillIconProps) {
