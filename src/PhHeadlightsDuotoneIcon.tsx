...
export interface PhHeadlightsDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHeadlightsDuotoneIcon(props: PhHeadlightsDuotoneIconProps) {
