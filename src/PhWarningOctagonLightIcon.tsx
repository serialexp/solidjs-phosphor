...
export interface PhWarningOctagonLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWarningOctagonLightIcon(props: PhWarningOctagonLightIconProps) {
