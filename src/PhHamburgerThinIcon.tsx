...
export interface PhHamburgerThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHamburgerThinIcon(props: PhHamburgerThinIconProps) {
