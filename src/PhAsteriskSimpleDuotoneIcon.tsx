...
export interface PhAsteriskSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAsteriskSimpleDuotoneIcon(props: PhAsteriskSimpleDuotoneIconProps) {
