...
export interface PhTerminalWindowBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTerminalWindowBoldIcon(props: PhTerminalWindowBoldIconProps) {
