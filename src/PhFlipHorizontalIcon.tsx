...
export interface PhFlipHorizontalIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlipHorizontalIcon(props: PhFlipHorizontalIconProps) {
