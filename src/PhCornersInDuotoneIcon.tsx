...
export interface PhCornersInDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCornersInDuotoneIcon(props: PhCornersInDuotoneIconProps) {
