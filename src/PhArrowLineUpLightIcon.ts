...
export type { PhIconProps as PhArrowLineUpLightIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowLineUpLightIcon = createIcon(`<path d="M204.24,139.76a6,6,0,1,1-8.48,8.48L134,86.49V224a6,6,0,0,1-12,0V86.49L60.24,148.24a6,6,0,0,1-8.48-8.48l72-72a6,6,0,0,1,8.48,0ZM216,34H40a6,6,0,0,0,0,12H216a6,6,0,0,0,0-12Z"/>`);
