...
export type { PhIconProps as PhAlignCenterHorizontalSimpleDuotoneIconProps } from "./createIcon.js";
 ...
 */
export const PhAlignCenterHorizontalSimpleDuotoneIcon = createIcon(`<path d="M216,96v64a8,8,0,0,1-8,8H48a8,8,0,0,1-8-8V96a8,8,0,0,1,8-8H208A8,8,0,0,1,216,96Z" opacity="0.2"/><path d="M208,80H136V48a8,8,0,0,0-16,0V80H48A16,16,0,0,0,32,96v64a16,16,0,0,0,16,16h72v32a8,8,0,0,0,16,0V176h72a16,16,0,0,0,16-16V96A16,16,0,0,0,208,80Zm0,80H48V96H208v64Z"/>`);
