...
export interface PhLetterCircleVIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLetterCircleVIcon(props: PhLetterCircleVIconProps) {
