...
export interface PhSketchLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSketchLogoDuotoneIcon(props: PhSketchLogoDuotoneIconProps) {
