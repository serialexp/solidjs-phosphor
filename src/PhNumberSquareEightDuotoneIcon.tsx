...
export interface PhNumberSquareEightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareEightDuotoneIcon(props: PhNumberSquareEightDuotoneIconProps) {
