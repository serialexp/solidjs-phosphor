...
export type { PhIconProps as PhRadioButtonBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhRadioButtonBoldIcon = createIcon(`<path d="M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212Zm0-140a56,56,0,1,0,56,56A56.06,56.06,0,0,0,128,72Zm0,88a32,32,0,1,1,32-32A32,32,0,0,1,128,160Z"/>`);
