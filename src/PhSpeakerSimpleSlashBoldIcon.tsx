...
export interface PhSpeakerSimpleSlashBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleSlashBoldIcon(props: PhSpeakerSimpleSlashBoldIconProps) {
