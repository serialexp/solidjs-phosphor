...
export interface PhGoogleCardboardLogoBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleCardboardLogoBoldIcon(props: PhGoogleCardboardLogoBoldIconProps) {
