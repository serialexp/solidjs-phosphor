...
export interface PhFirstAidKitThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidKitThinIcon(props: PhFirstAidKitThinIconProps) {
