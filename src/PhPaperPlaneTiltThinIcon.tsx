...
export interface PhPaperPlaneTiltThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneTiltThinIcon(props: PhPaperPlaneTiltThinIconProps) {
