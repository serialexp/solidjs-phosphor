...
export interface PhLockSimpleOpenFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockSimpleOpenFillIcon(props: PhLockSimpleOpenFillIconProps) {
