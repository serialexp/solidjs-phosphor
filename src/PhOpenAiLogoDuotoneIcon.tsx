...
export interface PhOpenAiLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhOpenAiLogoDuotoneIcon(props: PhOpenAiLogoDuotoneIconProps) {
