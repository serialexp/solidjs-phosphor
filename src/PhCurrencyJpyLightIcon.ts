...
export type { PhIconProps as PhCurrencyJpyLightIconProps } from "./createIcon.js";
 ...
 */
export const PhCurrencyJpyLightIcon = createIcon(`<path d="M204.64,51.8l-64,78.2H176a6,6,0,0,1,0,12H134v20h42a6,6,0,0,1,0,12H134v42a6,6,0,0,1-12,0V174H80a6,6,0,0,1,0-12h42V142H80a6,6,0,0,1,0-12h35.34l-64-78.2a6,6,0,1,1,9.28-7.6L128,126.53,195.36,44.2a6,6,0,0,1,9.28,7.6Z"/>`);
