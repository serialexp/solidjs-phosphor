...
export interface PhNumberCircleNineIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleNineIcon(props: PhNumberCircleNineIconProps) {
