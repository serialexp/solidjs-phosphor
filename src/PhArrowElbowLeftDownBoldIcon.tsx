...
export interface PhArrowElbowLeftDownBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowElbowLeftDownBoldIcon(props: PhArrowElbowLeftDownBoldIconProps) {
