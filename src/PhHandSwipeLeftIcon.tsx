...
export interface PhHandSwipeLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeLeftIcon(props: PhHandSwipeLeftIconProps) {
