...
export interface PhFirstAidKitBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidKitBoldIcon(props: PhFirstAidKitBoldIconProps) {
