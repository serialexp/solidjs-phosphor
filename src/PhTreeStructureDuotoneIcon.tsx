...
export interface PhTreeStructureDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreeStructureDuotoneIcon(props: PhTreeStructureDuotoneIconProps) {
