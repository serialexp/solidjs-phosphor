...
export interface PhSpeakerSimpleLowThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleLowThinIcon(props: PhSpeakerSimpleLowThinIconProps) {
