...
export interface PhBaseballCapThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBaseballCapThinIcon(props: PhBaseballCapThinIconProps) {
