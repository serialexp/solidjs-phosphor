...
export interface PhTextHFiveThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHFiveThinIcon(props: PhTextHFiveThinIconProps) {
