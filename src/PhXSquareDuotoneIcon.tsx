...
export interface PhXSquareDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhXSquareDuotoneIcon(props: PhXSquareDuotoneIconProps) {
