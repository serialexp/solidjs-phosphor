...
export interface PhShieldCheckeredIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShieldCheckeredIcon(props: PhShieldCheckeredIconProps) {
