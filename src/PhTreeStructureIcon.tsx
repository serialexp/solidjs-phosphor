...
export interface PhTreeStructureIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreeStructureIcon(props: PhTreeStructureIconProps) {
