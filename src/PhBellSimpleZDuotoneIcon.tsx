...
export interface PhBellSimpleZDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBellSimpleZDuotoneIcon(props: PhBellSimpleZDuotoneIconProps) {
