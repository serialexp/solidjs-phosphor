...
export interface PhArrowLineUpLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowLineUpLeftIcon(props: PhArrowLineUpLeftIconProps) {
