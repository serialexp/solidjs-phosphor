...
export interface PhQuestionMarkDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhQuestionMarkDuotoneIcon(props: PhQuestionMarkDuotoneIconProps) {
