...
export interface PhPinterestLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPinterestLogoIcon(props: PhPinterestLogoIconProps) {
