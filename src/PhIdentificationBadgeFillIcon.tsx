...
export interface PhIdentificationBadgeFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeFillIcon(props: PhIdentificationBadgeFillIconProps) {
