...
export interface PhShieldPlusThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShieldPlusThinIcon(props: PhShieldPlusThinIconProps) {
