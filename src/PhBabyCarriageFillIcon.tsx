...
export interface PhBabyCarriageFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBabyCarriageFillIcon(props: PhBabyCarriageFillIconProps) {
