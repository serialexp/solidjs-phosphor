...
export interface PhLineSegmentThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLineSegmentThinIcon(props: PhLineSegmentThinIconProps) {
