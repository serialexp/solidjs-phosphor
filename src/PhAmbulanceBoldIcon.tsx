...
export interface PhAmbulanceBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmbulanceBoldIcon(props: PhAmbulanceBoldIconProps) {
