...
export interface PhNumberCircleEightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleEightDuotoneIcon(props: PhNumberCircleEightDuotoneIconProps) {
