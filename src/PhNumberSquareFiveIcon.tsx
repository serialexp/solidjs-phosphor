...
export interface PhNumberSquareFiveIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareFiveIcon(props: PhNumberSquareFiveIconProps) {
