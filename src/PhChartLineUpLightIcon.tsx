...
export interface PhChartLineUpLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartLineUpLightIcon(props: PhChartLineUpLightIconProps) {
