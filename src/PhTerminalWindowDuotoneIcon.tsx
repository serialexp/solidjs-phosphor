...
export interface PhTerminalWindowDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTerminalWindowDuotoneIcon(props: PhTerminalWindowDuotoneIconProps) {
