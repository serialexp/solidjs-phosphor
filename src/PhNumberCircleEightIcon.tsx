...
export interface PhNumberCircleEightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleEightIcon(props: PhNumberCircleEightIconProps) {
