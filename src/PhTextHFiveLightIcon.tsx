...
export interface PhTextHFiveLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHFiveLightIcon(props: PhTextHFiveLightIconProps) {
