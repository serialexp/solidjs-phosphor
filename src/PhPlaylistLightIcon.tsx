...
export interface PhPlaylistLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPlaylistLightIcon(props: PhPlaylistLightIconProps) {
