...
export interface PhTrashSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrashSimpleDuotoneIcon(props: PhTrashSimpleDuotoneIconProps) {
