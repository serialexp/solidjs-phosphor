...
export interface PhMouseScrollBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMouseScrollBoldIcon(props: PhMouseScrollBoldIconProps) {
