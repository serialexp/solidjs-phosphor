...
export interface PhAsclepiusFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAsclepiusFillIcon(props: PhAsclepiusFillIconProps) {
