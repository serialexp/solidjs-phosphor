...
export interface PhPushPinSimpleSlashIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPushPinSimpleSlashIcon(props: PhPushPinSimpleSlashIconProps) {
