...
export interface PhFolderSimpleLockDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleLockDuotoneIcon(props: PhFolderSimpleLockDuotoneIconProps) {
