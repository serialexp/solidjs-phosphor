...
export interface PhArrowsClockwiseLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowsClockwiseLightIcon(props: PhArrowsClockwiseLightIconProps) {
