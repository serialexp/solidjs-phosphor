...
export interface PhLightningSlashIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLightningSlashIcon(props: PhLightningSlashIconProps) {
