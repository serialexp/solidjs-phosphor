...
export interface PhBaseballHelmetIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBaseballHelmetIcon(props: PhBaseballHelmetIconProps) {
