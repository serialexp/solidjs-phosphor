...
export interface PhTrayArrowUpBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrayArrowUpBoldIcon(props: PhTrayArrowUpBoldIconProps) {
