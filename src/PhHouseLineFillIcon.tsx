...
export interface PhHouseLineFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHouseLineFillIcon(props: PhHouseLineFillIconProps) {
