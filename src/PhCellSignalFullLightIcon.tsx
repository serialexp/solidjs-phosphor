...
export interface PhCellSignalFullLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalFullLightIcon(props: PhCellSignalFullLightIconProps) {
