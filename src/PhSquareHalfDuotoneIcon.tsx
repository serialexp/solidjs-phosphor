...
export interface PhSquareHalfDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSquareHalfDuotoneIcon(props: PhSquareHalfDuotoneIconProps) {
