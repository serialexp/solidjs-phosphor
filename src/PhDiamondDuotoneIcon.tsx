...
export interface PhDiamondDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiamondDuotoneIcon(props: PhDiamondDuotoneIconProps) {
