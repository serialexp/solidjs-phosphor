...
export interface PhVectorThreeLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVectorThreeLightIcon(props: PhVectorThreeLightIconProps) {
