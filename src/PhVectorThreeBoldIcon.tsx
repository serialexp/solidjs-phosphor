...
export interface PhVectorThreeBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVectorThreeBoldIcon(props: PhVectorThreeBoldIconProps) {
