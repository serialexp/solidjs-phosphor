...
export interface PhHandGrabbingBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandGrabbingBoldIcon(props: PhHandGrabbingBoldIconProps) {
