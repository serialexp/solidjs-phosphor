...
export interface PhInstagramLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhInstagramLogoDuotoneIcon(props: PhInstagramLogoDuotoneIconProps) {
