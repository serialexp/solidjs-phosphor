...
export interface PhFileAudioBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileAudioBoldIcon(props: PhFileAudioBoldIconProps) {
