...
export interface PhGoogleCardboardLogoThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleCardboardLogoThinIcon(props: PhGoogleCardboardLogoThinIconProps) {
