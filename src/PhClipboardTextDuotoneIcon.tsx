...
export interface PhClipboardTextDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClipboardTextDuotoneIcon(props: PhClipboardTextDuotoneIconProps) {
