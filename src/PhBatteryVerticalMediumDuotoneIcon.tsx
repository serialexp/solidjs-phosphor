...
export interface PhBatteryVerticalMediumDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryVerticalMediumDuotoneIcon(props: PhBatteryVerticalMediumDuotoneIconProps) {
