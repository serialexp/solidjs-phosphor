...
export interface PhDiamondsFourLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiamondsFourLightIcon(props: PhDiamondsFourLightIconProps) {
