...
export interface PhSteeringWheelThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSteeringWheelThinIcon(props: PhSteeringWheelThinIconProps) {
