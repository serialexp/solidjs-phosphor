...
export interface PhNotchesDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNotchesDuotoneIcon(props: PhNotchesDuotoneIconProps) {
