...
export type { PhIconProps as PhAlignRightSimpleLightIconProps } from "./createIcon.js";
 ...
 */
export const PhAlignRightSimpleLightIcon = createIcon(`<path d="M230,56V200a6,6,0,0,1-12,0V56a6,6,0,0,1,12,0ZM198,96v64a14,14,0,0,1-14,14H32a14,14,0,0,1-14-14V96A14,14,0,0,1,32,82H184A14,14,0,0,1,198,96Zm-12,0a2,2,0,0,0-2-2H32a2,2,0,0,0-2,2v64a2,2,0,0,0,2,2H184a2,2,0,0,0,2-2Z"/>`);
