...
export interface PhPaperPlaneTiltDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneTiltDuotoneIcon(props: PhPaperPlaneTiltDuotoneIconProps) {
