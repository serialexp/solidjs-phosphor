...
export interface PhStarAndCrescentDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStarAndCrescentDuotoneIcon(props: PhStarAndCrescentDuotoneIconProps) {
