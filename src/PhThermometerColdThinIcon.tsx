...
export interface PhThermometerColdThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerColdThinIcon(props: PhThermometerColdThinIconProps) {
