...
export interface PhNumberSquareZeroIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareZeroIcon(props: PhNumberSquareZeroIconProps) {
