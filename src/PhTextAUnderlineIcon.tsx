...
export interface PhTextAUnderlineIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextAUnderlineIcon(props: PhTextAUnderlineIconProps) {
