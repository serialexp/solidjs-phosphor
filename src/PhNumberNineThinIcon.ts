...
export type { PhIconProps as PhNumberNineThinIconProps } from "./createIcon.js";
 ...
 */
export const PhNumberNineThinIcon = createIcon(`<path d="M128,44a52,52,0,1,0,24.74,97.73L116.51,206a4,4,0,0,0,7,3.92L173,122A52,52,0,0,0,128,44Zm0,96a44,44,0,1,1,44-44A44.05,44.05,0,0,1,128,140Z"/>`);
