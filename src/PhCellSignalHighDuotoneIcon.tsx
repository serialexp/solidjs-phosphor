...
export interface PhCellSignalHighDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalHighDuotoneIcon(props: PhCellSignalHighDuotoneIconProps) {
