...
export interface PhClockClockwiseThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClockClockwiseThinIcon(props: PhClockClockwiseThinIconProps) {
