...
export interface PhCheckSquareFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckSquareFillIcon(props: PhCheckSquareFillIconProps) {
