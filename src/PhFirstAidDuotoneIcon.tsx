...
export interface PhFirstAidDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidDuotoneIcon(props: PhFirstAidDuotoneIconProps) {
