...
export interface PhDiamondsFourBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiamondsFourBoldIcon(props: PhDiamondsFourBoldIconProps) {
