...
export interface PhArrowUUpRightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowUUpRightThinIcon(props: PhArrowUUpRightThinIconProps) {
