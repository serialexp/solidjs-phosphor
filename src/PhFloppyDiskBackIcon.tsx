...
export interface PhFloppyDiskBackIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFloppyDiskBackIcon(props: PhFloppyDiskBackIconProps) {
