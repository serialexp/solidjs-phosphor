...
export interface PhSolarPanelThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSolarPanelThinIcon(props: PhSolarPanelThinIconProps) {
