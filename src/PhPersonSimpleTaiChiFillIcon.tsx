...
export interface PhPersonSimpleTaiChiFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleTaiChiFillIcon(props: PhPersonSimpleTaiChiFillIconProps) {
