...
export interface PhKeyReturnFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhKeyReturnFillIcon(props: PhKeyReturnFillIconProps) {
