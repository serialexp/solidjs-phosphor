...
export type { PhIconProps as PhLessThanBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhLessThanBoldIcon = createIcon(`<path d="M210.84,205.13a12,12,0,0,1-16,5.71l-152-72a12,12,0,0,1,0-21.68l152-72a12,12,0,1,1,10.27,21.69L76,128l129.1,61.15A12,12,0,0,1,210.84,205.13Z"/>`);
