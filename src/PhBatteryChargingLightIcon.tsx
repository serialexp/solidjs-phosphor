...
export interface PhBatteryChargingLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryChargingLightIcon(props: PhBatteryChargingLightIconProps) {
