...
export interface PhFilmReelDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmReelDuotoneIcon(props: PhFilmReelDuotoneIconProps) {
