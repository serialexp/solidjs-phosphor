...
export interface PhMicrosoftExcelLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrosoftExcelLogoIcon(props: PhMicrosoftExcelLogoIconProps) {
