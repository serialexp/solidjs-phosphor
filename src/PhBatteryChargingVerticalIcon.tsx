...
export interface PhBatteryChargingVerticalIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryChargingVerticalIcon(props: PhBatteryChargingVerticalIconProps) {
