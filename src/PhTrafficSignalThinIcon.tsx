...
export interface PhTrafficSignalThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrafficSignalThinIcon(props: PhTrafficSignalThinIconProps) {
