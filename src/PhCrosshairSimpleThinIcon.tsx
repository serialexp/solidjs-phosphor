...
export interface PhCrosshairSimpleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCrosshairSimpleThinIcon(props: PhCrosshairSimpleThinIconProps) {
