...
export interface PhHandPeaceDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandPeaceDuotoneIcon(props: PhHandPeaceDuotoneIconProps) {
