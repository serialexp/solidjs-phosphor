...
export type { PhIconProps as PhFramerLogoFillIconProps } from "./createIcon.js";
 ...
 */
export const PhFramerLogoFillIcon = createIcon(`<path d="M200,112H149l56.27,50A8,8,0,0,1,200,176H136v64a8,8,0,0,1-13.66,5.66l-72-72A8,8,0,0,1,48,168V104a8,8,0,0,1,8-8h51L50.69,46A8,8,0,0,1,56,32H200a8,8,0,0,1,8,8v64A8,8,0,0,1,200,112Z"/>`);
