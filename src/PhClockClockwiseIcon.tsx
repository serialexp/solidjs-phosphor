...
export interface PhClockClockwiseIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClockClockwiseIcon(props: PhClockClockwiseIconProps) {
