...
export interface PhExcludeSquareIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhExcludeSquareIcon(props: PhExcludeSquareIconProps) {
