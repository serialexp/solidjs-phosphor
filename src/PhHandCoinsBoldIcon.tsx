...
export interface PhHandCoinsBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandCoinsBoldIcon(props: PhHandCoinsBoldIconProps) {
