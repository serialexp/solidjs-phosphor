...
export interface PhMagnifyingGlassPlusDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMagnifyingGlassPlusDuotoneIcon(props: PhMagnifyingGlassPlusDuotoneIconProps) {
