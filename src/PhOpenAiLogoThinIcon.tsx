...
export interface PhOpenAiLogoThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhOpenAiLogoThinIcon(props: PhOpenAiLogoThinIconProps) {
