...
export interface PhPresentationDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPresentationDuotoneIcon(props: PhPresentationDuotoneIconProps) {
