...
export interface PhAirplaneInFlightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneInFlightIcon(props: PhAirplaneInFlightIconProps) {
