...
export interface PhImagesSquareThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhImagesSquareThinIcon(props: PhImagesSquareThinIconProps) {
