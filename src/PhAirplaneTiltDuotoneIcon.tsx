...
export interface PhAirplaneTiltDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneTiltDuotoneIcon(props: PhAirplaneTiltDuotoneIconProps) {
