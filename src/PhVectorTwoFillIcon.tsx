...
export interface PhVectorTwoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVectorTwoFillIcon(props: PhVectorTwoFillIconProps) {
