...
export interface PhMicrophoneLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrophoneLightIcon(props: PhMicrophoneLightIconProps) {
