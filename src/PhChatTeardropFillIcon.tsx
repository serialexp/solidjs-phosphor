...
export interface PhChatTeardropFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropFillIcon(props: PhChatTeardropFillIconProps) {
