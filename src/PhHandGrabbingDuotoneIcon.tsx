...
export interface PhHandGrabbingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandGrabbingDuotoneIcon(props: PhHandGrabbingDuotoneIconProps) {
