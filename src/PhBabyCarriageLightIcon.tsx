...
export interface PhBabyCarriageLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBabyCarriageLightIcon(props: PhBabyCarriageLightIconProps) {
