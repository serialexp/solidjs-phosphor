...
export interface PhGoogleCardboardLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleCardboardLogoFillIcon(props: PhGoogleCardboardLogoFillIconProps) {
