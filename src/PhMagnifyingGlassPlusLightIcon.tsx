...
export interface PhMagnifyingGlassPlusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMagnifyingGlassPlusLightIcon(props: PhMagnifyingGlassPlusLightIconProps) {
