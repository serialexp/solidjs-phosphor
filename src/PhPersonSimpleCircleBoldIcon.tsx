...
export interface PhPersonSimpleCircleBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleCircleBoldIcon(props: PhPersonSimpleCircleBoldIconProps) {
