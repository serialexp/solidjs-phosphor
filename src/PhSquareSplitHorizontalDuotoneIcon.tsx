...
export interface PhSquareSplitHorizontalDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSquareSplitHorizontalDuotoneIcon(props: PhSquareSplitHorizontalDuotoneIconProps) {
