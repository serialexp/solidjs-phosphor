...
export interface PhCloudMoonBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCloudMoonBoldIcon(props: PhCloudMoonBoldIconProps) {
