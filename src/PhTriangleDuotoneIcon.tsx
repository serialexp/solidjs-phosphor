...
export interface PhTriangleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTriangleDuotoneIcon(props: PhTriangleDuotoneIconProps) {
