...
export interface PhAirplaneTakeoffIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneTakeoffIcon(props: PhAirplaneTakeoffIconProps) {
