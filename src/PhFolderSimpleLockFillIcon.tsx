...
export interface PhFolderSimpleLockFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleLockFillIcon(props: PhFolderSimpleLockFillIconProps) {
