...
export interface PhProjectorScreenDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhProjectorScreenDuotoneIcon(props: PhProjectorScreenDuotoneIconProps) {
