...
export interface PhSpeakerSimpleXIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleXIcon(props: PhSpeakerSimpleXIconProps) {
