...
export interface PhUserMinusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserMinusLightIcon(props: PhUserMinusLightIconProps) {
