...
export interface PhFilmScriptDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmScriptDuotoneIcon(props: PhFilmScriptDuotoneIconProps) {
