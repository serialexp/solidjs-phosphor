...
export interface PhSpotifyLogoBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpotifyLogoBoldIcon(props: PhSpotifyLogoBoldIconProps) {
