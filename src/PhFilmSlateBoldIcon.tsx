...
export interface PhFilmSlateBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmSlateBoldIcon(props: PhFilmSlateBoldIconProps) {
