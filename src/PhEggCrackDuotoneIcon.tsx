...
export interface PhEggCrackDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhEggCrackDuotoneIcon(props: PhEggCrackDuotoneIconProps) {
