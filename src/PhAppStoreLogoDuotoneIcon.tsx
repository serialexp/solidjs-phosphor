...
export interface PhAppStoreLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAppStoreLogoDuotoneIcon(props: PhAppStoreLogoDuotoneIconProps) {
