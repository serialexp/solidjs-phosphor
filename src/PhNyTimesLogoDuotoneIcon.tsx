...
export interface PhNyTimesLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNyTimesLogoDuotoneIcon(props: PhNyTimesLogoDuotoneIconProps) {
