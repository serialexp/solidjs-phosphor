...
export interface PhArrowsLeftRightBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowsLeftRightBoldIcon(props: PhArrowsLeftRightBoldIconProps) {
