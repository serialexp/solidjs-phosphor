...
export interface PhHandCoinsLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandCoinsLightIcon(props: PhHandCoinsLightIconProps) {
