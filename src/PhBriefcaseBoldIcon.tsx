...
export interface PhBriefcaseBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBriefcaseBoldIcon(props: PhBriefcaseBoldIconProps) {
