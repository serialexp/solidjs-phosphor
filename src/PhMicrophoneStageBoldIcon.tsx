...
export interface PhMicrophoneStageBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrophoneStageBoldIcon(props: PhMicrophoneStageBoldIconProps) {
