...
export interface PhIntersectSquareDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectSquareDuotoneIcon(props: PhIntersectSquareDuotoneIconProps) {
