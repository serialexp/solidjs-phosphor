...
export interface PhSuitcaseRollingFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSuitcaseRollingFillIcon(props: PhSuitcaseRollingFillIconProps) {
