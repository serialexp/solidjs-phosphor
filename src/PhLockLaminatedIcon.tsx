...
export interface PhLockLaminatedIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockLaminatedIcon(props: PhLockLaminatedIconProps) {
