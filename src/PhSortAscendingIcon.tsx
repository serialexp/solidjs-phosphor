...
export interface PhSortAscendingIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSortAscendingIcon(props: PhSortAscendingIconProps) {
