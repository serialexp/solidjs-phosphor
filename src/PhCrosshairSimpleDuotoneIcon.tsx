...
export interface PhCrosshairSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCrosshairSimpleDuotoneIcon(props: PhCrosshairSimpleDuotoneIconProps) {
