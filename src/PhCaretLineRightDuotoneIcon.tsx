...
export interface PhCaretLineRightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretLineRightDuotoneIcon(props: PhCaretLineRightDuotoneIconProps) {
