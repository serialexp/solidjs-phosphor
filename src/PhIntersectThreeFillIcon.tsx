...
export interface PhIntersectThreeFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectThreeFillIcon(props: PhIntersectThreeFillIconProps) {
