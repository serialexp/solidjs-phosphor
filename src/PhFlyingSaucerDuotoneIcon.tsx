...
export interface PhFlyingSaucerDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlyingSaucerDuotoneIcon(props: PhFlyingSaucerDuotoneIconProps) {
