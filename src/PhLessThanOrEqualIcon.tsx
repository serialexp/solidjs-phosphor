...
export interface PhLessThanOrEqualIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLessThanOrEqualIcon(props: PhLessThanOrEqualIconProps) {
