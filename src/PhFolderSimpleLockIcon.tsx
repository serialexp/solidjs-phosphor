...
export interface PhFolderSimpleLockIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleLockIcon(props: PhFolderSimpleLockIconProps) {
