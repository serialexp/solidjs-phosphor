...
export interface PhUserMinusThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserMinusThinIcon(props: PhUserMinusThinIconProps) {
