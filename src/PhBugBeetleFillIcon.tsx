...
export interface PhBugBeetleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBugBeetleFillIcon(props: PhBugBeetleFillIconProps) {
