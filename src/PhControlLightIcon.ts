...
export type { PhIconProps as PhControlLightIconProps } from "./createIcon.js";
 ...
 */
export const PhControlLightIcon = createIcon(`<path d="M204.24,124.24a6,6,0,0,1-8.48,0L128,56.49,60.24,124.24a6,6,0,0,1-8.48-8.48l72-72a6,6,0,0,1,8.48,0l72,72A6,6,0,0,1,204.24,124.24Z"/>`);
