...
export interface PhHourglassLowDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassLowDuotoneIcon(props: PhHourglassLowDuotoneIconProps) {
