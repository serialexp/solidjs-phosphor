...
export interface PhColumnsPlusLeftThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhColumnsPlusLeftThinIcon(props: PhColumnsPlusLeftThinIconProps) {
