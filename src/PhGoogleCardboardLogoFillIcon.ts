...
export type { PhIconProps as PhGoogleCardboardLogoFillIconProps } from "./createIcon.js";
 ...
 */
export const PhGoogleCardboardLogoFillIcon = createIcon(`<path d="M224,48H32A16,16,0,0,0,16,64V192a16,16,0,0,0,16,16H96a8,8,0,0,0,5.66-2.34L128,179.31l26.34,26.35A8,8,0,0,0,160,208h64a16,16,0,0,0,16-16V64A16,16,0,0,0,224,48ZM80,152a24,24,0,1,1,24-24A24,24,0,0,1,80,152Zm96,0a24,24,0,1,1,24-24A24,24,0,0,1,176,152Z"/>`);
