...
export type { PhIconProps as PhCaretLineRightThinIconProps } from "./createIcon.js";
 ...
 */
export const PhCaretLineRightThinIcon = createIcon(`<path d="M146.83,125.17a4,4,0,0,1,0,5.66l-80,80a4,4,0,0,1-5.66-5.66L138.34,128,61.17,50.83a4,4,0,0,1,5.66-5.66ZM184,44a4,4,0,0,0-4,4V208a4,4,0,0,0,8,0V48A4,4,0,0,0,184,44Z"/>`);
