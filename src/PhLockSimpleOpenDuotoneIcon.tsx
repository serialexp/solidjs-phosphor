...
export interface PhLockSimpleOpenDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockSimpleOpenDuotoneIcon(props: PhLockSimpleOpenDuotoneIconProps) {
