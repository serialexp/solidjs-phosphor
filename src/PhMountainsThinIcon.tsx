...
export interface PhMountainsThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMountainsThinIcon(props: PhMountainsThinIconProps) {
