...
export interface PhArrowFatLineUpIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLineUpIcon(props: PhArrowFatLineUpIconProps) {
