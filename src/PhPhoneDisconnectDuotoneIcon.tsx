...
export interface PhPhoneDisconnectDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneDisconnectDuotoneIcon(props: PhPhoneDisconnectDuotoneIconProps) {
