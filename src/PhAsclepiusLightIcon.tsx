...
export interface PhAsclepiusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAsclepiusLightIcon(props: PhAsclepiusLightIconProps) {
