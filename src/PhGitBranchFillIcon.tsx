...
export interface PhGitBranchFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGitBranchFillIcon(props: PhGitBranchFillIconProps) {
