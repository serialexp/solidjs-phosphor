...
export interface PhTrafficSignalLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrafficSignalLightIcon(props: PhTrafficSignalLightIconProps) {
