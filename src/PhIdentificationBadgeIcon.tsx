...
export interface PhIdentificationBadgeIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeIcon(props: PhIdentificationBadgeIconProps) {
