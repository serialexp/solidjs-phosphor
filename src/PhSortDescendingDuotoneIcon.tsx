...
export interface PhSortDescendingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSortDescendingDuotoneIcon(props: PhSortDescendingDuotoneIconProps) {
