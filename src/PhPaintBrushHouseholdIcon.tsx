...
export interface PhPaintBrushHouseholdIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaintBrushHouseholdIcon(props: PhPaintBrushHouseholdIconProps) {
