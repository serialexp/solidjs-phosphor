...
export interface PhSlideshowDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSlideshowDuotoneIcon(props: PhSlideshowDuotoneIconProps) {
