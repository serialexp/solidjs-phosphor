...
export interface PhDeviceMobileCameraThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDeviceMobileCameraThinIcon(props: PhDeviceMobileCameraThinIconProps) {
