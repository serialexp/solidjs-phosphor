...
export interface PhPaperPlaneTiltFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneTiltFillIcon(props: PhPaperPlaneTiltFillIconProps) {
