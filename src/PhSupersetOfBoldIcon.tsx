...
export interface PhSupersetOfBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSupersetOfBoldIcon(props: PhSupersetOfBoldIconProps) {
