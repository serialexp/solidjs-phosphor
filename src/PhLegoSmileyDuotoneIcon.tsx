...
export interface PhLegoSmileyDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLegoSmileyDuotoneIcon(props: PhLegoSmileyDuotoneIconProps) {
