...
export interface PhSolarPanelBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSolarPanelBoldIcon(props: PhSolarPanelBoldIconProps) {
