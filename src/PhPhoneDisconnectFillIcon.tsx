...
export interface PhPhoneDisconnectFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneDisconnectFillIcon(props: PhPhoneDisconnectFillIconProps) {
