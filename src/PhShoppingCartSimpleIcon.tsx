...
export interface PhShoppingCartSimpleIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShoppingCartSimpleIcon(props: PhShoppingCartSimpleIconProps) {
