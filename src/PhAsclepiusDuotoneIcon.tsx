...
export interface PhAsclepiusDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAsclepiusDuotoneIcon(props: PhAsclepiusDuotoneIconProps) {
