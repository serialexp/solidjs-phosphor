...
export interface PhTrashSimpleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrashSimpleThinIcon(props: PhTrashSimpleThinIconProps) {
