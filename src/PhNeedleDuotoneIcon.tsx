...
export interface PhNeedleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNeedleDuotoneIcon(props: PhNeedleDuotoneIconProps) {
