...
export interface PhPerspectiveBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPerspectiveBoldIcon(props: PhPerspectiveBoldIconProps) {
