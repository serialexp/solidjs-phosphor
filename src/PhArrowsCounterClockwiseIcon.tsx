...
export interface PhArrowsCounterClockwiseIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowsCounterClockwiseIcon(props: PhArrowsCounterClockwiseIconProps) {
