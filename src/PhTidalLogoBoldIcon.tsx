...
export interface PhTidalLogoBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTidalLogoBoldIcon(props: PhTidalLogoBoldIconProps) {
