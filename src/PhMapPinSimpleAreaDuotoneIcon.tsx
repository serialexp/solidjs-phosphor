...
export interface PhMapPinSimpleAreaDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinSimpleAreaDuotoneIcon(props: PhMapPinSimpleAreaDuotoneIconProps) {
