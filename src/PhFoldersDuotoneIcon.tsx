...
export interface PhFoldersDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFoldersDuotoneIcon(props: PhFoldersDuotoneIconProps) {
