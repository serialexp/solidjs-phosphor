...
export interface PhListDashesLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListDashesLightIcon(props: PhListDashesLightIconProps) {
