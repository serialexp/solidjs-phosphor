...
export interface PhWashingMachineLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWashingMachineLightIcon(props: PhWashingMachineLightIconProps) {
