...
export interface PhPaintBrushHouseholdFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaintBrushHouseholdFillIcon(props: PhPaintBrushHouseholdFillIconProps) {
