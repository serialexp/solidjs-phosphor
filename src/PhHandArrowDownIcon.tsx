...
export interface PhHandArrowDownIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandArrowDownIcon(props: PhHandArrowDownIconProps) {
