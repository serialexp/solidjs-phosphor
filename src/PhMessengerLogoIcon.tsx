...
export interface PhMessengerLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMessengerLogoIcon(props: PhMessengerLogoIconProps) {
