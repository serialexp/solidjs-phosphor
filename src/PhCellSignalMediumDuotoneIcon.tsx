...
export interface PhCellSignalMediumDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalMediumDuotoneIcon(props: PhCellSignalMediumDuotoneIconProps) {
