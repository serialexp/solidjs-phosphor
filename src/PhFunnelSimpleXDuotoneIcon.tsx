...
export interface PhFunnelSimpleXDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFunnelSimpleXDuotoneIcon(props: PhFunnelSimpleXDuotoneIconProps) {
