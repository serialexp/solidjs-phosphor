...
export interface PhVideoConferenceBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVideoConferenceBoldIcon(props: PhVideoConferenceBoldIconProps) {
