...
export interface PhTextHThreeThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHThreeThinIcon(props: PhTextHThreeThinIconProps) {
