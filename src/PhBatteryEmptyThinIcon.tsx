...
export interface PhBatteryEmptyThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryEmptyThinIcon(props: PhBatteryEmptyThinIconProps) {
