...
export interface PhVinylRecordBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVinylRecordBoldIcon(props: PhVinylRecordBoldIconProps) {
