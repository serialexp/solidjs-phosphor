...
export interface PhNumberNineThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberNineThinIcon(props: PhNumberNineThinIconProps) {
