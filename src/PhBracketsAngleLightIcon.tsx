...
export interface PhBracketsAngleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBracketsAngleLightIcon(props: PhBracketsAngleLightIconProps) {
