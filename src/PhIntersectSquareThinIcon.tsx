...
export interface PhIntersectSquareThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectSquareThinIcon(props: PhIntersectSquareThinIconProps) {
