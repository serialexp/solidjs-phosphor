...
export interface PhArrowBendUpLeftDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowBendUpLeftDuotoneIcon(props: PhArrowBendUpLeftDuotoneIconProps) {
