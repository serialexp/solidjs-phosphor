...
export interface PhPiggyBankLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPiggyBankLightIcon(props: PhPiggyBankLightIconProps) {
