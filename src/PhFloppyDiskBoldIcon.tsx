...
export interface PhFloppyDiskBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFloppyDiskBoldIcon(props: PhFloppyDiskBoldIconProps) {
