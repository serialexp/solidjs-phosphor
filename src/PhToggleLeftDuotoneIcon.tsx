...
export interface PhToggleLeftDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhToggleLeftDuotoneIcon(props: PhToggleLeftDuotoneIconProps) {
