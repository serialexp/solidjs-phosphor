...
export interface PhSpeakerSimpleLowBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleLowBoldIcon(props: PhSpeakerSimpleLowBoldIconProps) {
