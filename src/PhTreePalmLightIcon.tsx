...
export interface PhTreePalmLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreePalmLightIcon(props: PhTreePalmLightIconProps) {
