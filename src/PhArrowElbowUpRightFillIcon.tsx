...
export interface PhArrowElbowUpRightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowElbowUpRightFillIcon(props: PhArrowElbowUpRightFillIconProps) {
