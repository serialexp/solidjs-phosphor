...
export interface PhCheckSquareThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckSquareThinIcon(props: PhCheckSquareThinIconProps) {
