...
export interface PhPencilCircleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPencilCircleDuotoneIcon(props: PhPencilCircleDuotoneIconProps) {
