...
export interface PhChartLineDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartLineDuotoneIcon(props: PhChartLineDuotoneIconProps) {
