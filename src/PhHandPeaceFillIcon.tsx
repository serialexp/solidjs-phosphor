...
export interface PhHandPeaceFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandPeaceFillIcon(props: PhHandPeaceFillIconProps) {
