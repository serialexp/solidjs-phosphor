...
export interface PhMagnifyingGlassPlusThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMagnifyingGlassPlusThinIcon(props: PhMagnifyingGlassPlusThinIconProps) {
