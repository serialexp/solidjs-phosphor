...
export interface PhGoogleCardboardLogoLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleCardboardLogoLightIcon(props: PhGoogleCardboardLogoLightIconProps) {
