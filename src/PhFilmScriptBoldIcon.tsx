...
export interface PhFilmScriptBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmScriptBoldIcon(props: PhFilmScriptBoldIconProps) {
