...
export interface PhDiamondsFourDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiamondsFourDuotoneIcon(props: PhDiamondsFourDuotoneIconProps) {
