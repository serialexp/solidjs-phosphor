...
export interface PhEscalatorUpThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhEscalatorUpThinIcon(props: PhEscalatorUpThinIconProps) {
