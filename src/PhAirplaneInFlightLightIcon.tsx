...
export interface PhAirplaneInFlightLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneInFlightLightIcon(props: PhAirplaneInFlightLightIconProps) {
