...
export interface PhKeyReturnLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhKeyReturnLightIcon(props: PhKeyReturnLightIconProps) {
