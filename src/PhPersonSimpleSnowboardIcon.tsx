...
export interface PhPersonSimpleSnowboardIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleSnowboardIcon(props: PhPersonSimpleSnowboardIconProps) {
