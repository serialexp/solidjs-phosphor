...
export interface PhFilmScriptFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmScriptFillIcon(props: PhFilmScriptFillIconProps) {
