...
export interface PhWaveformLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWaveformLightIcon(props: PhWaveformLightIconProps) {
