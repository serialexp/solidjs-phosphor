...
export interface PhTrademarkDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrademarkDuotoneIcon(props: PhTrademarkDuotoneIconProps) {
