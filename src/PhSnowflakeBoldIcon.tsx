...
export interface PhSnowflakeBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSnowflakeBoldIcon(props: PhSnowflakeBoldIconProps) {
