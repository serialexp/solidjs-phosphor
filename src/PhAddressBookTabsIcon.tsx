...
export interface PhAddressBookTabsIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAddressBookTabsIcon(props: PhAddressBookTabsIconProps) {
