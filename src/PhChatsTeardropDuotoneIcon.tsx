...
export interface PhChatsTeardropDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatsTeardropDuotoneIcon(props: PhChatsTeardropDuotoneIconProps) {
