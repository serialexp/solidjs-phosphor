...
export interface PhAlignCenterHorizontalIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAlignCenterHorizontalIcon(props: PhAlignCenterHorizontalIconProps) {
