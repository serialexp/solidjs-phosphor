...
export interface PhFileAudioDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileAudioDuotoneIcon(props: PhFileAudioDuotoneIconProps) {
