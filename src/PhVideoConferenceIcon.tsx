...
export interface PhVideoConferenceIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVideoConferenceIcon(props: PhVideoConferenceIconProps) {
