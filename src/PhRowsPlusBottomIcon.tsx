...
export interface PhRowsPlusBottomIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhRowsPlusBottomIcon(props: PhRowsPlusBottomIconProps) {
