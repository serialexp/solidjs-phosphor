...
export interface PhCalendarMinusBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarMinusBoldIcon(props: PhCalendarMinusBoldIconProps) {
