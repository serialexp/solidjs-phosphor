...
export interface PhShoppingBagDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShoppingBagDuotoneIcon(props: PhShoppingBagDuotoneIconProps) {
