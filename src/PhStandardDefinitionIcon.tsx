...
export interface PhStandardDefinitionIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStandardDefinitionIcon(props: PhStandardDefinitionIconProps) {
