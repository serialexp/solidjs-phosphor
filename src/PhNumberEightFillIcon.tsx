...
export interface PhNumberEightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberEightFillIcon(props: PhNumberEightFillIconProps) {
