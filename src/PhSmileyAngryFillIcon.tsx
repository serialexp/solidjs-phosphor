...
export interface PhSmileyAngryFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSmileyAngryFillIcon(props: PhSmileyAngryFillIconProps) {
