...
export interface PhIntersectionFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectionFillIcon(props: PhIntersectionFillIconProps) {
