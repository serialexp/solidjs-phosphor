...
export interface PhFalloutShelterDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFalloutShelterDuotoneIcon(props: PhFalloutShelterDuotoneIconProps) {
