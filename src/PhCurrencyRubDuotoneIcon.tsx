...
export interface PhCurrencyRubDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyRubDuotoneIcon(props: PhCurrencyRubDuotoneIconProps) {
