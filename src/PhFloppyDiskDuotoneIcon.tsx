...
export interface PhFloppyDiskDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFloppyDiskDuotoneIcon(props: PhFloppyDiskDuotoneIconProps) {
