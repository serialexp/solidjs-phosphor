...
export interface PhSpeakerSimpleSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleSlashDuotoneIcon(props: PhSpeakerSimpleSlashDuotoneIconProps) {
