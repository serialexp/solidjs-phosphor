...
export interface PhGitMergeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGitMergeDuotoneIcon(props: PhGitMergeDuotoneIconProps) {
