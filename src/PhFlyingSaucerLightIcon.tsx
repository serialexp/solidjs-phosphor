...
export interface PhFlyingSaucerLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlyingSaucerLightIcon(props: PhFlyingSaucerLightIconProps) {
