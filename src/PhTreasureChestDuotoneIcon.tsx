...
export interface PhTreasureChestDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreasureChestDuotoneIcon(props: PhTreasureChestDuotoneIconProps) {
