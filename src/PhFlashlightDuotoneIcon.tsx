...
export interface PhFlashlightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlashlightDuotoneIcon(props: PhFlashlightDuotoneIconProps) {
