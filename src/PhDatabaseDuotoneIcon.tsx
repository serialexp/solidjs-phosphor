...
export interface PhDatabaseDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDatabaseDuotoneIcon(props: PhDatabaseDuotoneIconProps) {
