...
export interface PhSuitcaseSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSuitcaseSimpleDuotoneIcon(props: PhSuitcaseSimpleDuotoneIconProps) {
