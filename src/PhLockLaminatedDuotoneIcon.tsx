...
export interface PhLockLaminatedDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockLaminatedDuotoneIcon(props: PhLockLaminatedDuotoneIconProps) {
