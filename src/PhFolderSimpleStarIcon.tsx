...
export interface PhFolderSimpleStarIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleStarIcon(props: PhFolderSimpleStarIconProps) {
