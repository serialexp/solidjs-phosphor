...
export interface PhMopedFrontBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMopedFrontBoldIcon(props: PhMopedFrontBoldIconProps) {
