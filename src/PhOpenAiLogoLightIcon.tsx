...
export interface PhOpenAiLogoLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhOpenAiLogoLightIcon(props: PhOpenAiLogoLightIconProps) {
