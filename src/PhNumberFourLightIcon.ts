...
export type { PhIconProps as PhNumberFourLightIconProps } from "./createIcon.js";
 ...
 */
export const PhNumberFourLightIcon = createIcon(`<path d="M184,162H166V48a6,6,0,0,0-10.69-3.75l-96,120A6,6,0,0,0,64,174h90v34a6,6,0,0,0,12,0V174h18a6,6,0,0,0,0-12Zm-30,0H76.48L154,65.1Z"/>`);
