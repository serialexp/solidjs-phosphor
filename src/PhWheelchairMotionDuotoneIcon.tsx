...
export interface PhWheelchairMotionDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWheelchairMotionDuotoneIcon(props: PhWheelchairMotionDuotoneIconProps) {
