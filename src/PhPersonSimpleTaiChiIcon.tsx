...
export interface PhPersonSimpleTaiChiIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleTaiChiIcon(props: PhPersonSimpleTaiChiIconProps) {
