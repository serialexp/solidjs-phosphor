...
export interface PhSynagogueThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSynagogueThinIcon(props: PhSynagogueThinIconProps) {
