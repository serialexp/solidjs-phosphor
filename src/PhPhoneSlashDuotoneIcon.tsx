...
export interface PhPhoneSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneSlashDuotoneIcon(props: PhPhoneSlashDuotoneIconProps) {
