...
export interface PhFolderDashedBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderDashedBoldIcon(props: PhFolderDashedBoldIconProps) {
