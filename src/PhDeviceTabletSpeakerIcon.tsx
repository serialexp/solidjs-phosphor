...
export interface PhDeviceTabletSpeakerIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDeviceTabletSpeakerIcon(props: PhDeviceTabletSpeakerIconProps) {
