...
export interface PhWheelchairMotionFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWheelchairMotionFillIcon(props: PhWheelchairMotionFillIconProps) {
