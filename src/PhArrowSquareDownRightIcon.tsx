...
export interface PhArrowSquareDownRightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowSquareDownRightIcon(props: PhArrowSquareDownRightIconProps) {
