...
export interface PhPaintRollerFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaintRollerFillIcon(props: PhPaintRollerFillIconProps) {
