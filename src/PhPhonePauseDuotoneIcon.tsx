...
export interface PhPhonePauseDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhonePauseDuotoneIcon(props: PhPhonePauseDuotoneIconProps) {
