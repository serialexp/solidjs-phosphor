...
export interface PhSubtitlesDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSubtitlesDuotoneIcon(props: PhSubtitlesDuotoneIconProps) {
