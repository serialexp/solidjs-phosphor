...
export interface PhPersonArmsSpreadDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonArmsSpreadDuotoneIcon(props: PhPersonArmsSpreadDuotoneIconProps) {
