...
export interface PhTextItalicDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextItalicDuotoneIcon(props: PhTextItalicDuotoneIconProps) {
