...
export interface PhMicrosoftPowerpointLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrosoftPowerpointLogoIcon(props: PhMicrosoftPowerpointLogoIconProps) {
