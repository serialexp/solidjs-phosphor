...
export interface PhLetterCircleHBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLetterCircleHBoldIcon(props: PhLetterCircleHBoldIconProps) {
