...
export interface PhMaskSadDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMaskSadDuotoneIcon(props: PhMaskSadDuotoneIconProps) {
