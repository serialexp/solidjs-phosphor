...
export interface PhFolderUserDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderUserDuotoneIcon(props: PhFolderUserDuotoneIconProps) {
