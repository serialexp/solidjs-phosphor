...
export interface PhTextOutdentDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextOutdentDuotoneIcon(props: PhTextOutdentDuotoneIconProps) {
