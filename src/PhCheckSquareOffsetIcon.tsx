...
export interface PhCheckSquareOffsetIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckSquareOffsetIcon(props: PhCheckSquareOffsetIconProps) {
