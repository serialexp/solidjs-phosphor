...
export interface PhCylinderDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCylinderDuotoneIcon(props: PhCylinderDuotoneIconProps) {
