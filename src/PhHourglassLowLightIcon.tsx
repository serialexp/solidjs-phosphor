...
export interface PhHourglassLowLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassLowLightIcon(props: PhHourglassLowLightIconProps) {
