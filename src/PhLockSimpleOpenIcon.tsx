...
export interface PhLockSimpleOpenIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockSimpleOpenIcon(props: PhLockSimpleOpenIconProps) {
