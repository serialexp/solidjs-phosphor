...
export interface PhArrowFatLinesLeftLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLinesLeftLightIcon(props: PhArrowFatLinesLeftLightIconProps) {
