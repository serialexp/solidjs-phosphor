...
export interface PhSteeringWheelLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSteeringWheelLightIcon(props: PhSteeringWheelLightIconProps) {
