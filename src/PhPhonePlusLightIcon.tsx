...
export interface PhPhonePlusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhonePlusLightIcon(props: PhPhonePlusLightIconProps) {
