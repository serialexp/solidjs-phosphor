...
export interface PhRowsPlusTopDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhRowsPlusTopDuotoneIcon(props: PhRowsPlusTopDuotoneIconProps) {
