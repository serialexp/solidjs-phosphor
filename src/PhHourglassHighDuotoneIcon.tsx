...
export interface PhHourglassHighDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassHighDuotoneIcon(props: PhHourglassHighDuotoneIconProps) {
