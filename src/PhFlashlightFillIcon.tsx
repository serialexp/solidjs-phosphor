...
export interface PhFlashlightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlashlightFillIcon(props: PhFlashlightFillIconProps) {
