...
export interface PhProjectorScreenFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhProjectorScreenFillIcon(props: PhProjectorScreenFillIconProps) {
