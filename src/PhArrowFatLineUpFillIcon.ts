...
export type { PhIconProps as PhArrowFatLineUpFillIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowFatLineUpFillIcon = createIcon(`<path d="M184,216a8,8,0,0,1-8,8H80a8,8,0,0,1,0-16h96A8,8,0,0,1,184,216Zm45.66-101.66-96-96a8,8,0,0,0-11.32,0l-96,96A8,8,0,0,0,32,128H72v56a8,8,0,0,0,8,8h96a8,8,0,0,0,8-8V128h40a8,8,0,0,0,5.66-13.66Z"/>`);
