...
export interface PhExcludeSquareDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhExcludeSquareDuotoneIcon(props: PhExcludeSquareDuotoneIconProps) {
