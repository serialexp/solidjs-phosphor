...
export interface PhScalesDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhScalesDuotoneIcon(props: PhScalesDuotoneIconProps) {
