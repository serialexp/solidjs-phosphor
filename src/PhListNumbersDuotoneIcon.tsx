...
export interface PhListNumbersDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListNumbersDuotoneIcon(props: PhListNumbersDuotoneIconProps) {
