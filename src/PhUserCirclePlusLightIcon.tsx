...
export interface PhUserCirclePlusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCirclePlusLightIcon(props: PhUserCirclePlusLightIconProps) {
