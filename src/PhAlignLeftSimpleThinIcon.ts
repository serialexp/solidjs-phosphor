...
export type { PhIconProps as PhAlignLeftSimpleThinIconProps } from "./createIcon.js";
 ...
 */
export const PhAlignLeftSimpleThinIcon = createIcon(`<path d="M36,56V200a4,4,0,0,1-8,0V56a4,4,0,0,1,8,0ZM236,96v64a12,12,0,0,1-12,12H72a12,12,0,0,1-12-12V96A12,12,0,0,1,72,84H224A12,12,0,0,1,236,96Zm-8,0a4,4,0,0,0-4-4H72a4,4,0,0,0-4,4v64a4,4,0,0,0,4,4H224a4,4,0,0,0,4-4Z"/>`);
