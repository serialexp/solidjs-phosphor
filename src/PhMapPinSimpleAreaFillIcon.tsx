...
export interface PhMapPinSimpleAreaFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinSimpleAreaFillIcon(props: PhMapPinSimpleAreaFillIconProps) {
