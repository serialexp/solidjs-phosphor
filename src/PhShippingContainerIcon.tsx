...
export interface PhShippingContainerIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShippingContainerIcon(props: PhShippingContainerIconProps) {
