...
export interface PhFilmReelLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmReelLightIcon(props: PhFilmReelLightIconProps) {
