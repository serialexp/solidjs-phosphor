...
export interface PhTrayArrowUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrayArrowUpDuotoneIcon(props: PhTrayArrowUpDuotoneIconProps) {
