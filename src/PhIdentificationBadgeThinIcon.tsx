...
export interface PhIdentificationBadgeThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeThinIcon(props: PhIdentificationBadgeThinIconProps) {
