...
export interface PhBugBeetleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBugBeetleLightIcon(props: PhBugBeetleLightIconProps) {
