...
export interface PhPlaylistDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPlaylistDuotoneIcon(props: PhPlaylistDuotoneIconProps) {
