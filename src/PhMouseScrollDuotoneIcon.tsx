...
export interface PhMouseScrollDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMouseScrollDuotoneIcon(props: PhMouseScrollDuotoneIconProps) {
