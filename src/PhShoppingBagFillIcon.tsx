...
export interface PhShoppingBagFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShoppingBagFillIcon(props: PhShoppingBagFillIconProps) {
