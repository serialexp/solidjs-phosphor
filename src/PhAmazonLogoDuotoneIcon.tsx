...
export interface PhAmazonLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmazonLogoDuotoneIcon(props: PhAmazonLogoDuotoneIconProps) {
