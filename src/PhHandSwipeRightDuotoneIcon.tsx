...
export interface PhHandSwipeRightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeRightDuotoneIcon(props: PhHandSwipeRightDuotoneIconProps) {
