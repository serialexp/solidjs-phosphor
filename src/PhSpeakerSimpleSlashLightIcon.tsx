...
export interface PhSpeakerSimpleSlashLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleSlashLightIcon(props: PhSpeakerSimpleSlashLightIconProps) {
