...
export interface PhBugBeetleBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBugBeetleBoldIcon(props: PhBugBeetleBoldIconProps) {
