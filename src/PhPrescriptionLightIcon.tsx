...
export interface PhPrescriptionLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPrescriptionLightIcon(props: PhPrescriptionLightIconProps) {
