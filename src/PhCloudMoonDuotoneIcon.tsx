...
export interface PhCloudMoonDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCloudMoonDuotoneIcon(props: PhCloudMoonDuotoneIconProps) {
