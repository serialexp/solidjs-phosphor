...
export interface PhCashRegisterFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCashRegisterFillIcon(props: PhCashRegisterFillIconProps) {
