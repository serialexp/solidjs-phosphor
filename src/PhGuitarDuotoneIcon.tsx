...
export interface PhGuitarDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGuitarDuotoneIcon(props: PhGuitarDuotoneIconProps) {
