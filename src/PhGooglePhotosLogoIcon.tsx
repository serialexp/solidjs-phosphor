...
export interface PhGooglePhotosLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGooglePhotosLogoIcon(props: PhGooglePhotosLogoIconProps) {
