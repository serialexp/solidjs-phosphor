...
export interface PhHandGrabbingThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandGrabbingThinIcon(props: PhHandGrabbingThinIconProps) {
