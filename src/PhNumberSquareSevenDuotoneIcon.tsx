...
export interface PhNumberSquareSevenDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareSevenDuotoneIcon(props: PhNumberSquareSevenDuotoneIconProps) {
