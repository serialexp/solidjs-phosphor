...
export interface PhTerminalWindowFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTerminalWindowFillIcon(props: PhTerminalWindowFillIconProps) {
