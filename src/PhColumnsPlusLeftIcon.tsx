...
export interface PhColumnsPlusLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhColumnsPlusLeftIcon(props: PhColumnsPlusLeftIconProps) {
