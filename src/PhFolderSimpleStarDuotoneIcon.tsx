...
export interface PhFolderSimpleStarDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleStarDuotoneIcon(props: PhFolderSimpleStarDuotoneIconProps) {
