...
export interface PhAsclepiusThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAsclepiusThinIcon(props: PhAsclepiusThinIconProps) {
