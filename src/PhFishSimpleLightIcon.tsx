...
export interface PhFishSimpleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFishSimpleLightIcon(props: PhFishSimpleLightIconProps) {
