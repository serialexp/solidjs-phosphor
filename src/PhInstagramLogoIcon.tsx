...
export interface PhInstagramLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhInstagramLogoIcon(props: PhInstagramLogoIconProps) {
