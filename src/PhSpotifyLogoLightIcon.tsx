...
export interface PhSpotifyLogoLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpotifyLogoLightIcon(props: PhSpotifyLogoLightIconProps) {
