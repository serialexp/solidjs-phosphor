...
export interface PhCellSignalXFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalXFillIcon(props: PhCellSignalXFillIconProps) {
