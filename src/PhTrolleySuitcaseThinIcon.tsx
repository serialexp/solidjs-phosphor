...
export interface PhTrolleySuitcaseThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrolleySuitcaseThinIcon(props: PhTrolleySuitcaseThinIconProps) {
