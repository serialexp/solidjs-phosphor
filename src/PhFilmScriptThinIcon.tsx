...
export interface PhFilmScriptThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFilmScriptThinIcon(props: PhFilmScriptThinIconProps) {
