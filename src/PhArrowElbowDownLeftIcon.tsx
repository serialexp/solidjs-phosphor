...
export interface PhArrowElbowDownLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowElbowDownLeftIcon(props: PhArrowElbowDownLeftIconProps) {
