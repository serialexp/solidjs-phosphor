...
export interface PhGitBranchDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGitBranchDuotoneIcon(props: PhGitBranchDuotoneIconProps) {
