...
export interface PhBuildingOfficeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBuildingOfficeDuotoneIcon(props: PhBuildingOfficeDuotoneIconProps) {
