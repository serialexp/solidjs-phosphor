...
export interface PhCalendarMinusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarMinusLightIcon(props: PhCalendarMinusLightIconProps) {
