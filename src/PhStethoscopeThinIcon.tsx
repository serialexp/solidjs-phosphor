...
export interface PhStethoscopeThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStethoscopeThinIcon(props: PhStethoscopeThinIconProps) {
