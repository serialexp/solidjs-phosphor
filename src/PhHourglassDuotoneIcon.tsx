...
export interface PhHourglassDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassDuotoneIcon(props: PhHourglassDuotoneIconProps) {
