...
export interface PhIntersectThreeThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectThreeThinIcon(props: PhIntersectThreeThinIconProps) {
