...
export type { PhIconProps as PhJoystickFillIconProps } from "./createIcon.js";
 ...
 */
export const PhJoystickFillIcon = createIcon(`<path d="M224,160v48a16,16,0,0,1-16,16H48a16,16,0,0,1-16-16V160a16,16,0,0,1,16-16h72V95.19a40,40,0,1,1,16,0V144h72A16,16,0,0,1,224,160Zm-64-40a8,8,0,0,0,8,8h32a8,8,0,0,0,0-16H168A8,8,0,0,0,160,120Z"/>`);
