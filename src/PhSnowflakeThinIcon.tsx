...
export interface PhSnowflakeThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSnowflakeThinIcon(props: PhSnowflakeThinIconProps) {
