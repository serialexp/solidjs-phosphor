...
export interface PhCurrencyCnyLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyCnyLightIcon(props: PhCurrencyCnyLightIconProps) {
