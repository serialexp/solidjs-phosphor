...
export interface PhNumberCircleFiveIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleFiveIcon(props: PhNumberCircleFiveIconProps) {
