...
export interface PhFolderUserThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderUserThinIcon(props: PhFolderUserThinIconProps) {
