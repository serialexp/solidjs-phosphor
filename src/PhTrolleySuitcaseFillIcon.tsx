...
export interface PhTrolleySuitcaseFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrolleySuitcaseFillIcon(props: PhTrolleySuitcaseFillIconProps) {
