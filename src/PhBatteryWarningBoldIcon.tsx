...
export interface PhBatteryWarningBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryWarningBoldIcon(props: PhBatteryWarningBoldIconProps) {
