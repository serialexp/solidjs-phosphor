...
export interface PhTrayArrowUpThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrayArrowUpThinIcon(props: PhTrayArrowUpThinIconProps) {
