...
export type { PhIconProps as PhAlignRightSimpleIconProps } from "./createIcon.js";
 ...
 */
export const PhAlignRightSimpleIcon = createIcon(`<path d="M232,56V200a8,8,0,0,1-16,0V56a8,8,0,0,1,16,0ZM200,96v64a16,16,0,0,1-16,16H32a16,16,0,0,1-16-16V96A16,16,0,0,1,32,80H184A16,16,0,0,1,200,96Zm-16,0H32v64H184Z"/>`);
