...
export interface PhAirplaneTiltLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneTiltLightIcon(props: PhAirplaneTiltLightIconProps) {
