...
export interface PhBracketsAngleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBracketsAngleDuotoneIcon(props: PhBracketsAngleDuotoneIconProps) {
