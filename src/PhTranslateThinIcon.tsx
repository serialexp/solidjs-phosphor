...
export interface PhTranslateThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTranslateThinIcon(props: PhTranslateThinIconProps) {
