...
export interface PhTextAlignRightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextAlignRightDuotoneIcon(props: PhTextAlignRightDuotoneIconProps) {
