...
export interface PhClockClockwiseFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClockClockwiseFillIcon(props: PhClockClockwiseFillIconProps) {
