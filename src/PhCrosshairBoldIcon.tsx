...
export interface PhCrosshairBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCrosshairBoldIcon(props: PhCrosshairBoldIconProps) {
