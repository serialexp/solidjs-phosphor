...
export interface PhGoogleChromeLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleChromeLogoIcon(props: PhGoogleChromeLogoIconProps) {
