...
export interface PhMegaphoneDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMegaphoneDuotoneIcon(props: PhMegaphoneDuotoneIconProps) {
