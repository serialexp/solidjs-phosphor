...
export interface PhIntersectThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectThinIcon(props: PhIntersectThinIconProps) {
