...
export interface PhBatteryChargingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryChargingDuotoneIcon(props: PhBatteryChargingDuotoneIconProps) {
