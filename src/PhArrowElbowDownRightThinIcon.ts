...
export type { PhIconProps as PhArrowElbowDownRightThinIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowElbowDownRightThinIcon = createIcon(`<path d="M218.83,178.83l-48,48a4,4,0,0,1-5.66-5.66L206.34,180H72a4,4,0,0,1-4-4V32a4,4,0,0,1,8,0V172H206.34l-41.17-41.17a4,4,0,1,1,5.66-5.66l48,48A4,4,0,0,1,218.83,178.83Z"/>`);
