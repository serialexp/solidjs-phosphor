...
export interface PhStarAndCrescentFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStarAndCrescentFillIcon(props: PhStarAndCrescentFillIconProps) {
