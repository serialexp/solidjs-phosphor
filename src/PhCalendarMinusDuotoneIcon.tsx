...
export interface PhCalendarMinusDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarMinusDuotoneIcon(props: PhCalendarMinusDuotoneIconProps) {
