...
export interface PhBaseballCapBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBaseballCapBoldIcon(props: PhBaseballCapBoldIconProps) {
