...
export interface PhSelectionSlashIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionSlashIcon(props: PhSelectionSlashIconProps) {
