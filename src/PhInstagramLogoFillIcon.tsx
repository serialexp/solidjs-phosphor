...
export interface PhInstagramLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhInstagramLogoFillIcon(props: PhInstagramLogoFillIconProps) {
