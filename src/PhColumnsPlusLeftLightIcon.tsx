...
export interface PhColumnsPlusLeftLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhColumnsPlusLeftLightIcon(props: PhColumnsPlusLeftLightIconProps) {
