...
export interface PhBathtubDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBathtubDuotoneIcon(props: PhBathtubDuotoneIconProps) {
