...
export interface PhBracketsAngleIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBracketsAngleIcon(props: PhBracketsAngleIconProps) {
