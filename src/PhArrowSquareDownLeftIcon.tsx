...
export interface PhArrowSquareDownLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowSquareDownLeftIcon(props: PhArrowSquareDownLeftIconProps) {
