...
export interface PhCloudCheckDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCloudCheckDuotoneIcon(props: PhCloudCheckDuotoneIconProps) {
