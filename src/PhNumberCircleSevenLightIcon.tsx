...
export interface PhNumberCircleSevenLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleSevenLightIcon(props: PhNumberCircleSevenLightIconProps) {
