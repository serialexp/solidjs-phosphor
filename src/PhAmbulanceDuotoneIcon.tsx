...
export interface PhAmbulanceDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmbulanceDuotoneIcon(props: PhAmbulanceDuotoneIconProps) {
