...
export interface PhCellSignalFullBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalFullBoldIcon(props: PhCellSignalFullBoldIconProps) {
