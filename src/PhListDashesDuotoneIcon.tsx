...
export interface PhListDashesDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListDashesDuotoneIcon(props: PhListDashesDuotoneIconProps) {
