...
export interface PhSortDescendingIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSortDescendingIcon(props: PhSortDescendingIconProps) {
