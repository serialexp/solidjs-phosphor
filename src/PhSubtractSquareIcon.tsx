...
export interface PhSubtractSquareIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSubtractSquareIcon(props: PhSubtractSquareIconProps) {
