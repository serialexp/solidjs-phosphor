...
export interface PhQuestionMarkFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhQuestionMarkFillIcon(props: PhQuestionMarkFillIconProps) {
