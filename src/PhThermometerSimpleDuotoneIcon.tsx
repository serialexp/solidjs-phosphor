...
export interface PhThermometerSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerSimpleDuotoneIcon(props: PhThermometerSimpleDuotoneIconProps) {
