...
export interface PhLineSegmentsDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLineSegmentsDuotoneIcon(props: PhLineSegmentsDuotoneIconProps) {
