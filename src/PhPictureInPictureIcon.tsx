...
export interface PhPictureInPictureIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPictureInPictureIcon(props: PhPictureInPictureIconProps) {
