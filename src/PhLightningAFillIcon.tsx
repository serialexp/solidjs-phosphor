...
export interface PhLightningAFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLightningAFillIcon(props: PhLightningAFillIconProps) {
