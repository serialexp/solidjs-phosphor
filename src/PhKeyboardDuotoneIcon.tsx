...
export interface PhKeyboardDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhKeyboardDuotoneIcon(props: PhKeyboardDuotoneIconProps) {
