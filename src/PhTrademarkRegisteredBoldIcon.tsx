...
export interface PhTrademarkRegisteredBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrademarkRegisteredBoldIcon(props: PhTrademarkRegisteredBoldIconProps) {
