...
export type { PhIconProps as PhPintGlassIconProps } from "./createIcon.js";
 ...
 */
export const PhPintGlassIcon = createIcon(`<path d="M206,26.69A8,8,0,0,0,200,24H56a8,8,0,0,0-7.94,9l23.15,193A16,16,0,0,0,87.1,240h81.8a16,16,0,0,0,15.89-14.09L207.94,33A8,8,0,0,0,206,26.69ZM191,40,188.1,64H67.9L65,40ZM168.9,224H87.1L69.82,80H186.18Z"/>`);
