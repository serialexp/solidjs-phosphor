...
export interface PhNumberNineDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberNineDuotoneIcon(props: PhNumberNineDuotoneIconProps) {
