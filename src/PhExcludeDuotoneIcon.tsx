...
export interface PhExcludeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhExcludeDuotoneIcon(props: PhExcludeDuotoneIconProps) {
