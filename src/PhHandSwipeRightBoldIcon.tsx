...
export interface PhHandSwipeRightBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeRightBoldIcon(props: PhHandSwipeRightBoldIconProps) {
