...
export type { PhIconProps as PhArrowUpLightIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowUpLightIcon = createIcon(`<path d="M204.24,116.24a6,6,0,0,1-8.48,0L134,54.49V216a6,6,0,0,1-12,0V54.49L60.24,116.24a6,6,0,0,1-8.48-8.48l72-72a6,6,0,0,1,8.48,0l72,72A6,6,0,0,1,204.24,116.24Z"/>`);
