...
export interface PhMusicNotesDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNotesDuotoneIcon(props: PhMusicNotesDuotoneIconProps) {
