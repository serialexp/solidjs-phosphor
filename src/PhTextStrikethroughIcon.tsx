...
export interface PhTextStrikethroughIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextStrikethroughIcon(props: PhTextStrikethroughIconProps) {
