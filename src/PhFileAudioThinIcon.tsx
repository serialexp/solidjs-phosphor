...
export interface PhFileAudioThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileAudioThinIcon(props: PhFileAudioThinIconProps) {
