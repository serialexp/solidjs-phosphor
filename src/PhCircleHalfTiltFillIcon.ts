...
export type { PhIconProps as PhCircleHalfTiltFillIconProps } from "./createIcon.js";
 ...
 */
export const PhCircleHalfTiltFillIcon = createIcon(`<path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24ZM40,128A88,88,0,0,1,190.2,65.8L65.8,190.2A87.76,87.76,0,0,1,40,128Z"/>`);
