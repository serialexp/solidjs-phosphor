...
export interface PhTextSuperscriptIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextSuperscriptIcon(props: PhTextSuperscriptIconProps) {
