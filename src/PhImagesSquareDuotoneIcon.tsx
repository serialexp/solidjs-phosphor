...
export interface PhImagesSquareDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhImagesSquareDuotoneIcon(props: PhImagesSquareDuotoneIconProps) {
