...
export interface PhChalkboardDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChalkboardDuotoneIcon(props: PhChalkboardDuotoneIconProps) {
