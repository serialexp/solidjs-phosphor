...
export interface PhCirclesThreePlusIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCirclesThreePlusIcon(props: PhCirclesThreePlusIconProps) {
