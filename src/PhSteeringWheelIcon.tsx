...
export interface PhSteeringWheelIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSteeringWheelIcon(props: PhSteeringWheelIconProps) {
