...
export interface PhCellSignalSlashFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalSlashFillIcon(props: PhCellSignalSlashFillIconProps) {
