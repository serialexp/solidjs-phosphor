...
export interface PhArrowSquareUpLeftDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowSquareUpLeftDuotoneIcon(props: PhArrowSquareUpLeftDuotoneIconProps) {
