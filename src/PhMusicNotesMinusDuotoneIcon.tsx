...
export interface PhMusicNotesMinusDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNotesMinusDuotoneIcon(props: PhMusicNotesMinusDuotoneIconProps) {
