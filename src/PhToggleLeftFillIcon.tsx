...
export interface PhToggleLeftFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhToggleLeftFillIcon(props: PhToggleLeftFillIconProps) {
