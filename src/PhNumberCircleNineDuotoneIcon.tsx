...
export interface PhNumberCircleNineDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleNineDuotoneIcon(props: PhNumberCircleNineDuotoneIconProps) {
