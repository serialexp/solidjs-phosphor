...
export interface PhChatTeardropTextDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropTextDuotoneIcon(props: PhChatTeardropTextDuotoneIconProps) {
