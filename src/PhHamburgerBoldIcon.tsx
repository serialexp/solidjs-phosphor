...
export interface PhHamburgerBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHamburgerBoldIcon(props: PhHamburgerBoldIconProps) {
