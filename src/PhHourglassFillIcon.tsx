...
export interface PhHourglassFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassFillIcon(props: PhHourglassFillIconProps) {
