...
export interface PhThermometerColdLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerColdLightIcon(props: PhThermometerColdLightIconProps) {
