...
export type { PhIconProps as PhArrowElbowLeftDownLightIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowElbowLeftDownLightIcon = createIcon(`<path d="M238,72a6,6,0,0,1-6,6H94V201.51l37.76-37.75a6,6,0,0,1,8.48,8.48l-48,48a6,6,0,0,1-8.48,0l-48-48a6,6,0,0,1,8.48-8.48L82,201.51V72a6,6,0,0,1,6-6H232A6,6,0,0,1,238,72Z"/>`);
