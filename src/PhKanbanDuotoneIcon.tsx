...
export interface PhKanbanDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhKanbanDuotoneIcon(props: PhKanbanDuotoneIconProps) {
