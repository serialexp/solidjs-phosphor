...
export interface PhMapPinSimpleAreaIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinSimpleAreaIcon(props: PhMapPinSimpleAreaIconProps) {
