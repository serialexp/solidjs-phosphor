...
export interface PhChatsTeardropThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatsTeardropThinIcon(props: PhChatsTeardropThinIconProps) {
