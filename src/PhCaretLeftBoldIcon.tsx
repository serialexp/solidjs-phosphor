...
export interface PhCaretLeftBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretLeftBoldIcon(props: PhCaretLeftBoldIconProps) {
