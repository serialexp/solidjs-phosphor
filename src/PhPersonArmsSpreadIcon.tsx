...
export interface PhPersonArmsSpreadIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonArmsSpreadIcon(props: PhPersonArmsSpreadIconProps) {
