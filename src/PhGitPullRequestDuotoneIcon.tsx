...
export interface PhGitPullRequestDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGitPullRequestDuotoneIcon(props: PhGitPullRequestDuotoneIconProps) {
