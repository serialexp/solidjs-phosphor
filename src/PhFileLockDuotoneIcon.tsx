...
export interface PhFileLockDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileLockDuotoneIcon(props: PhFileLockDuotoneIconProps) {
