...
export interface PhUserCirclePlusFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCirclePlusFillIcon(props: PhUserCirclePlusFillIconProps) {
