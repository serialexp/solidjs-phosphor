...
export type { PhIconProps as PhPhosphorLogoThinIconProps } from "./createIcon.js";
 ...
 */
export const PhPhosphorLogoThinIcon = createIcon(`<path d="M152,36H72a4,4,0,0,0-4,4V168a76.08,76.08,0,0,0,76,76,4,4,0,0,0,4-4V172h4a68,68,0,0,0,0-136ZM76,55.27,137.16,164H76Zm64,97.46L78.84,44H140ZM76.13,172H140v63.88A68.1,68.1,0,0,1,76.13,172ZM152,164h-4V44h4a60,60,0,0,1,0,120Z"/>`);
