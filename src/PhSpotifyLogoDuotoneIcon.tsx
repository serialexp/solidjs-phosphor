...
export interface PhSpotifyLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpotifyLogoDuotoneIcon(props: PhSpotifyLogoDuotoneIconProps) {
