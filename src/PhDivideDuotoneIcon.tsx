...
export interface PhDivideDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDivideDuotoneIcon(props: PhDivideDuotoneIconProps) {
