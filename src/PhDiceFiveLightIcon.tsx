...
export interface PhDiceFiveLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDiceFiveLightIcon(props: PhDiceFiveLightIconProps) {
