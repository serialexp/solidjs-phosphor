...
export interface PhFolderDashedFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderDashedFillIcon(props: PhFolderDashedFillIconProps) {
