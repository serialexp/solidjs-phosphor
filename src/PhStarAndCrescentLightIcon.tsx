...
export interface PhStarAndCrescentLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStarAndCrescentLightIcon(props: PhStarAndCrescentLightIconProps) {
