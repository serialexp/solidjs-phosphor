...
export interface PhIdentificationBadgeBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeBoldIcon(props: PhIdentificationBadgeBoldIconProps) {
