...
export interface PhDotsThreeCircleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDotsThreeCircleThinIcon(props: PhDotsThreeCircleThinIconProps) {
