...
export interface PhCheckerboardFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckerboardFillIcon(props: PhCheckerboardFillIconProps) {
