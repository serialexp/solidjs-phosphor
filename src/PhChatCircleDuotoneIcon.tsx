...
export interface PhChatCircleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatCircleDuotoneIcon(props: PhChatCircleDuotoneIconProps) {
