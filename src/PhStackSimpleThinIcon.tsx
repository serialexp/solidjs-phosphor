...
export interface PhStackSimpleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStackSimpleThinIcon(props: PhStackSimpleThinIconProps) {
