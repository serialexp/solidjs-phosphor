...
export type { PhIconProps as PhGenderMaleBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhGenderMaleBoldIcon = createIcon(`<path d="M216,28H168a12,12,0,0,0,0,24h19L154.28,84.74a84,84,0,1,0,17,17L204,69V88a12,12,0,0,0,24,0V40A12,12,0,0,0,216,28ZM146.41,194.46a60,60,0,1,1,0-84.87A60.1,60.1,0,0,1,146.41,194.46Z"/>`);
