...
export interface PhSpeakerSimpleNoneDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleNoneDuotoneIcon(props: PhSpeakerSimpleNoneDuotoneIconProps) {
