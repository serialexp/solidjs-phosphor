...
export interface PhSpeedometerThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeedometerThinIcon(props: PhSpeedometerThinIconProps) {
