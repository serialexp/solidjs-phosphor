...
export interface PhVectorThreeFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVectorThreeFillIcon(props: PhVectorThreeFillIconProps) {
