...
export interface PhNumberOneBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberOneBoldIcon(props: PhNumberOneBoldIconProps) {
