...
export interface PhCloudSunDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCloudSunDuotoneIcon(props: PhCloudSunDuotoneIconProps) {
