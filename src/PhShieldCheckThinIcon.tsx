...
export interface PhShieldCheckThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShieldCheckThinIcon(props: PhShieldCheckThinIconProps) {
