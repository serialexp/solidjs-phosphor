...
export interface PhCraneTowerLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCraneTowerLightIcon(props: PhCraneTowerLightIconProps) {
