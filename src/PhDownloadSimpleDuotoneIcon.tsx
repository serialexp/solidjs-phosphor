...
export interface PhDownloadSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDownloadSimpleDuotoneIcon(props: PhDownloadSimpleDuotoneIconProps) {
