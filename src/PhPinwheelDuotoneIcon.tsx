...
export interface PhPinwheelDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPinwheelDuotoneIcon(props: PhPinwheelDuotoneIconProps) {
