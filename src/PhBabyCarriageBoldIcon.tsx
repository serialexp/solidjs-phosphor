...
export interface PhBabyCarriageBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBabyCarriageBoldIcon(props: PhBabyCarriageBoldIconProps) {
