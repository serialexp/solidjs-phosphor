...
export interface PhClipboardTextThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhClipboardTextThinIcon(props: PhClipboardTextThinIconProps) {
