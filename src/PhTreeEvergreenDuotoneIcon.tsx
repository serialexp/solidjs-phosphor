...
export interface PhTreeEvergreenDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreeEvergreenDuotoneIcon(props: PhTreeEvergreenDuotoneIconProps) {
