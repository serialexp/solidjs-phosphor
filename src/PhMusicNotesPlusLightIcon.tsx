...
export interface PhMusicNotesPlusLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNotesPlusLightIcon(props: PhMusicNotesPlusLightIconProps) {
