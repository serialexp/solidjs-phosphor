...
export interface PhNotepadDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNotepadDuotoneIcon(props: PhNotepadDuotoneIconProps) {
