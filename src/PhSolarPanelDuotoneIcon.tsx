...
export interface PhSolarPanelDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSolarPanelDuotoneIcon(props: PhSolarPanelDuotoneIconProps) {
