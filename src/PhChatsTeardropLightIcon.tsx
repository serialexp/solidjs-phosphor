...
export interface PhChatsTeardropLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatsTeardropLightIcon(props: PhChatsTeardropLightIconProps) {
