...
export interface PhTreasureChestFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreasureChestFillIcon(props: PhTreasureChestFillIconProps) {
