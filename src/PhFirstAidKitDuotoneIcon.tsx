...
export interface PhFirstAidKitDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidKitDuotoneIcon(props: PhFirstAidKitDuotoneIconProps) {
