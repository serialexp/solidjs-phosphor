...
export interface PhMagnifyingGlassDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMagnifyingGlassDuotoneIcon(props: PhMagnifyingGlassDuotoneIconProps) {
