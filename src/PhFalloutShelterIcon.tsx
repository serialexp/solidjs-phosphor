...
export interface PhFalloutShelterIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFalloutShelterIcon(props: PhFalloutShelterIconProps) {
