...
export interface PhHandSwipeRightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeRightThinIcon(props: PhHandSwipeRightThinIconProps) {
