...
export interface PhCalculatorThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalculatorThinIcon(props: PhCalculatorThinIconProps) {
