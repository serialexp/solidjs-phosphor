...
export interface PhProjectorScreenBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhProjectorScreenBoldIcon(props: PhProjectorScreenBoldIconProps) {
