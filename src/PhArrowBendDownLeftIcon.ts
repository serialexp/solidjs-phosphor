...
export type { PhIconProps as PhArrowBendDownLeftIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowBendDownLeftIcon = createIcon(`<path d="M232,56A104.11,104.11,0,0,1,128,160H51.31l34.35,34.34a8,8,0,0,1-11.32,11.32l-48-48a8,8,0,0,1,0-11.32l48-48a8,8,0,0,1,11.32,11.32L51.31,144H128a88.1,88.1,0,0,0,88-88,8,8,0,0,1,16,0Z"/>`);
