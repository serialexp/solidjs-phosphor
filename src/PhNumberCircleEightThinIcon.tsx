...
export interface PhNumberCircleEightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleEightThinIcon(props: PhNumberCircleEightThinIconProps) {
