...
export interface PhSelectionPlusIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionPlusIcon(props: PhSelectionPlusIconProps) {
