...
export interface PhGreaterThanOrEqualLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGreaterThanOrEqualLightIcon(props: PhGreaterThanOrEqualLightIconProps) {
