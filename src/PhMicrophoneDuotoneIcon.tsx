...
export interface PhMicrophoneDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrophoneDuotoneIcon(props: PhMicrophoneDuotoneIconProps) {
