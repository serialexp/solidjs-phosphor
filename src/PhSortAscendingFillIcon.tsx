...
export interface PhSortAscendingFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSortAscendingFillIcon(props: PhSortAscendingFillIconProps) {
