...
export interface PhTreeStructureLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreeStructureLightIcon(props: PhTreeStructureLightIconProps) {
