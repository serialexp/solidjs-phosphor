...
export interface PhFirstAidKitFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFirstAidKitFillIcon(props: PhFirstAidKitFillIconProps) {
