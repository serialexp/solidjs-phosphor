...
export interface PhPicnicTableDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPicnicTableDuotoneIcon(props: PhPicnicTableDuotoneIconProps) {
