...
export interface PhAlignCenterVerticalIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAlignCenterVerticalIcon(props: PhAlignCenterVerticalIconProps) {
