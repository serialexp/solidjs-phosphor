...
export interface PhHeartBreakFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHeartBreakFillIcon(props: PhHeartBreakFillIconProps) {
