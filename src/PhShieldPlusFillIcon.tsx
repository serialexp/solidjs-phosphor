...
export interface PhShieldPlusFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShieldPlusFillIcon(props: PhShieldPlusFillIconProps) {
