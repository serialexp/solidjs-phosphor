...
export interface PhDownloadSimpleIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDownloadSimpleIcon(props: PhDownloadSimpleIconProps) {
