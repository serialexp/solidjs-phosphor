...
export interface PhPiggyBankBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPiggyBankBoldIcon(props: PhPiggyBankBoldIconProps) {
