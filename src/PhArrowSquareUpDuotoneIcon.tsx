...
export interface PhArrowSquareUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowSquareUpDuotoneIcon(props: PhArrowSquareUpDuotoneIconProps) {
