...
export interface PhCurrencyCnyBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyCnyBoldIcon(props: PhCurrencyCnyBoldIconProps) {
