...
export interface PhCoffeeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCoffeeDuotoneIcon(props: PhCoffeeDuotoneIconProps) {
