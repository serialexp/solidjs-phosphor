...
export interface PhCalculatorFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalculatorFillIcon(props: PhCalculatorFillIconProps) {
