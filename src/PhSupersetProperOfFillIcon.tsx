...
export interface PhSupersetProperOfFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSupersetProperOfFillIcon(props: PhSupersetProperOfFillIconProps) {
