...
export interface PhSelectionLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionLightIcon(props: PhSelectionLightIconProps) {
