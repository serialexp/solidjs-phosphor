...
export type { PhIconProps as PhArrowElbowRightDownBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowElbowRightDownBoldIcon = createIcon(`<path d="M232.49,168.49l-48,48a12,12,0,0,1-17,0l-48-48a12,12,0,1,1,17-17L164,179V76H32a12,12,0,0,1,0-24H176a12,12,0,0,1,12,12V179l27.51-27.52a12,12,0,0,1,17,17Z"/>`);
