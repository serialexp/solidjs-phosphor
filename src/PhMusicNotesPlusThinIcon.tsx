...
export interface PhMusicNotesPlusThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNotesPlusThinIcon(props: PhMusicNotesPlusThinIconProps) {
