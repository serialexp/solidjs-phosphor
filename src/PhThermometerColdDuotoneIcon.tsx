...
export interface PhThermometerColdDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerColdDuotoneIcon(props: PhThermometerColdDuotoneIconProps) {
