...
export interface PhRoadHorizonThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhRoadHorizonThinIcon(props: PhRoadHorizonThinIconProps) {
