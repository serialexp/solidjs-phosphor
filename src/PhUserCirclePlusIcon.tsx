...
export interface PhUserCirclePlusIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCirclePlusIcon(props: PhUserCirclePlusIconProps) {
