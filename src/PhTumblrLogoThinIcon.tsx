...
export interface PhTumblrLogoThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTumblrLogoThinIcon(props: PhTumblrLogoThinIconProps) {
