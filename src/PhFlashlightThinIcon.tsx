...
export interface PhFlashlightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFlashlightThinIcon(props: PhFlashlightThinIconProps) {
