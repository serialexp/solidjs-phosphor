...
export interface PhPanoramaDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPanoramaDuotoneIcon(props: PhPanoramaDuotoneIconProps) {
