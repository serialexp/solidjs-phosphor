...
export type { PhIconProps as PhSpeakerSimpleNoneBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhSpeakerSimpleNoneBoldIcon = createIcon(`<path d="M165.27,21.22a12,12,0,0,0-12.64,1.31L83.88,76H40A20,20,0,0,0,20,96v64a20,20,0,0,0,20,20H83.88l68.75,53.47A12,12,0,0,0,172,224V32A12,12,0,0,0,165.27,21.22ZM148,199.46,95.37,158.53A12,12,0,0,0,88,156H44V100H88a12,12,0,0,0,7.37-2.53L148,56.54Z"/>`);
