...
export interface PhChartPieSliceIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartPieSliceIcon(props: PhChartPieSliceIconProps) {
