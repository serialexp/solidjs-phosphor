...
export interface PhFileImageDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileImageDuotoneIcon(props: PhFileImageDuotoneIconProps) {
