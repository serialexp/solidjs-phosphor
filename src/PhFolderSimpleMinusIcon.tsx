...
export interface PhFolderSimpleMinusIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleMinusIcon(props: PhFolderSimpleMinusIconProps) {
