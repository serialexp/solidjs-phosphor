...
export interface PhSuitcaseSimpleThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSuitcaseSimpleThinIcon(props: PhSuitcaseSimpleThinIconProps) {
