...
export interface PhNumberEightLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberEightLightIcon(props: PhNumberEightLightIconProps) {
