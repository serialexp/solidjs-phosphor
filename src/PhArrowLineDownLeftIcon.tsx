...
export interface PhArrowLineDownLeftIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowLineDownLeftIcon(props: PhArrowLineDownLeftIconProps) {
