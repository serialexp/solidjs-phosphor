...
export interface PhFolderUserBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderUserBoldIcon(props: PhFolderUserBoldIconProps) {
