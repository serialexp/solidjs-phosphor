...
export interface PhMusicNotesPlusBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNotesPlusBoldIcon(props: PhMusicNotesPlusBoldIconProps) {
