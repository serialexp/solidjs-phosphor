...
export interface PhBracketsRoundIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBracketsRoundIcon(props: PhBracketsRoundIconProps) {
