...
export interface PhCurrencyDollarSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyDollarSimpleDuotoneIcon(props: PhCurrencyDollarSimpleDuotoneIconProps) {
