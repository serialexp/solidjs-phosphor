...
export interface PhCopySimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCopySimpleDuotoneIcon(props: PhCopySimpleDuotoneIconProps) {
