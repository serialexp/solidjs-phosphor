...
export interface PhCellSignalNoneFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalNoneFillIcon(props: PhCellSignalNoneFillIconProps) {
