...
export interface PhArticleNyTimesIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArticleNyTimesIcon(props: PhArticleNyTimesIconProps) {
