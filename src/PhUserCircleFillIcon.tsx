...
export interface PhUserCircleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCircleFillIcon(props: PhUserCircleFillIconProps) {
