...
export interface PhEyedropperSampleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhEyedropperSampleFillIcon(props: PhEyedropperSampleFillIconProps) {
