...
export interface PhTidalLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTidalLogoDuotoneIcon(props: PhTidalLogoDuotoneIconProps) {
