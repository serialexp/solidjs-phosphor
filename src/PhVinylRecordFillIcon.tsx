...
export interface PhVinylRecordFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVinylRecordFillIcon(props: PhVinylRecordFillIconProps) {
