...
export interface PhFloppyDiskLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFloppyDiskLightIcon(props: PhFloppyDiskLightIconProps) {
