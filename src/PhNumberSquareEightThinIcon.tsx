...
export interface PhNumberSquareEightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberSquareEightThinIcon(props: PhNumberSquareEightThinIconProps) {
