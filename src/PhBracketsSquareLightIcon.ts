...
export type { PhIconProps as PhBracketsSquareLightIconProps } from "./createIcon.js";
 ...
 */
export const PhBracketsSquareLightIcon = createIcon(`<path d="M46,46V210H80a6,6,0,0,1,0,12H40a6,6,0,0,1-6-6V40a6,6,0,0,1,6-6H80a6,6,0,0,1,0,12ZM216,34H176a6,6,0,0,0,0,12h34V210H176a6,6,0,0,0,0,12h40a6,6,0,0,0,6-6V40A6,6,0,0,0,216,34Z"/>`);
