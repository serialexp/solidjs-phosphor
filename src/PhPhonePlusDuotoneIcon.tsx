...
export interface PhPhonePlusDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhonePlusDuotoneIcon(props: PhPhonePlusDuotoneIconProps) {
