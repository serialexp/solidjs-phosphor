...
export interface PhArrowSquareUpLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowSquareUpLightIcon(props: PhArrowSquareUpLightIconProps) {
