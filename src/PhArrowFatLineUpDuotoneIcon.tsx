...
export interface PhArrowFatLineUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLineUpDuotoneIcon(props: PhArrowFatLineUpDuotoneIconProps) {
