...
export interface PhArrowCounterClockwiseFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowCounterClockwiseFillIcon(props: PhArrowCounterClockwiseFillIconProps) {
