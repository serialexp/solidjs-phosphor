...
export interface PhMapPinSimpleAreaLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinSimpleAreaLightIcon(props: PhMapPinSimpleAreaLightIconProps) {
