...
export interface PhVirtualRealityIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVirtualRealityIcon(props: PhVirtualRealityIconProps) {
