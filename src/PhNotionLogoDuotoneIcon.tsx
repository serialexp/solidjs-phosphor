...
export interface PhNotionLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNotionLogoDuotoneIcon(props: PhNotionLogoDuotoneIconProps) {
