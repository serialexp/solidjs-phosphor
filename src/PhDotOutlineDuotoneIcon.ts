...
export type { PhIconProps as PhDotOutlineDuotoneIconProps } from "./createIcon.js";
 ...
 */
export const PhDotOutlineDuotoneIcon = createIcon(`<path d="M152,128a24,24,0,1,1-24-24A24,24,0,0,1,152,128Z" opacity="0.2"/><path d="M128,96a32,32,0,1,0,32,32A32,32,0,0,0,128,96Zm0,48a16,16,0,1,1,16-16A16,16,0,0,1,128,144Z"/>`);
