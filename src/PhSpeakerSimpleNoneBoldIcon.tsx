...
export interface PhSpeakerSimpleNoneBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleNoneBoldIcon(props: PhSpeakerSimpleNoneBoldIconProps) {
