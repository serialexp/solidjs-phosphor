...
export interface PhMonitorPlayDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMonitorPlayDuotoneIcon(props: PhMonitorPlayDuotoneIconProps) {
