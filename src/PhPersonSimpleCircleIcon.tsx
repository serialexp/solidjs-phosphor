...
export interface PhPersonSimpleCircleIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleCircleIcon(props: PhPersonSimpleCircleIconProps) {
