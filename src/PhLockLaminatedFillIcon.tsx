...
export interface PhLockLaminatedFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLockLaminatedFillIcon(props: PhLockLaminatedFillIconProps) {
