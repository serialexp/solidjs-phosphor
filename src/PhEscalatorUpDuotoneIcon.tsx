...
export interface PhEscalatorUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhEscalatorUpDuotoneIcon(props: PhEscalatorUpDuotoneIconProps) {
