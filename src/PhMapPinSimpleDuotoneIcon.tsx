...
export interface PhMapPinSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMapPinSimpleDuotoneIcon(props: PhMapPinSimpleDuotoneIconProps) {
