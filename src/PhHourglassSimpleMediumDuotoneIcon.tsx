...
export interface PhHourglassSimpleMediumDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassSimpleMediumDuotoneIcon(props: PhHourglassSimpleMediumDuotoneIconProps) {
