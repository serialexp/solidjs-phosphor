...
export interface PhArrowFatLineDownLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLineDownLightIcon(props: PhArrowFatLineDownLightIconProps) {
