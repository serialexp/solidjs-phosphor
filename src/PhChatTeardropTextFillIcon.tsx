...
export interface PhChatTeardropTextFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropTextFillIcon(props: PhChatTeardropTextFillIconProps) {
