...
export interface PhPresentationChartLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPresentationChartLightIcon(props: PhPresentationChartLightIconProps) {
