...
export interface PhGenderIntersexBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGenderIntersexBoldIcon(props: PhGenderIntersexBoldIconProps) {
