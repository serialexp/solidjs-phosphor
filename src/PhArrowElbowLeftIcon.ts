...
export type { PhIconProps as PhArrowElbowLeftIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowElbowLeftIcon = createIcon(`<path d="M237.66,101.66l-96,96a8,8,0,0,1-11.32,0L32,99.31V152a8,8,0,0,1-16,0V80a8,8,0,0,1,8-8H96a8,8,0,0,1,0,16H43.31L136,180.69l90.34-90.35a8,8,0,0,1,11.32,11.32Z"/>`);
