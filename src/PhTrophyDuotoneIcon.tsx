...
export interface PhTrophyDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrophyDuotoneIcon(props: PhTrophyDuotoneIconProps) {
