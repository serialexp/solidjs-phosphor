...
export interface PhFileVueDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileVueDuotoneIcon(props: PhFileVueDuotoneIconProps) {
