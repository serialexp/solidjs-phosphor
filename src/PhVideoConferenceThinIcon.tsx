...
export interface PhVideoConferenceThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVideoConferenceThinIcon(props: PhVideoConferenceThinIconProps) {
