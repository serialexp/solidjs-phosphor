...
export interface PhCheckSquareDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckSquareDuotoneIcon(props: PhCheckSquareDuotoneIconProps) {
