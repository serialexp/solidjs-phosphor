...
export interface PhKeyReturnBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhKeyReturnBoldIcon(props: PhKeyReturnBoldIconProps) {
