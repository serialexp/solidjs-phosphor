...
export interface PhAirplaneTiltBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneTiltBoldIcon(props: PhAirplaneTiltBoldIconProps) {
