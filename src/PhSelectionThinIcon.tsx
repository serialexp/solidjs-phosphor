...
export interface PhSelectionThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionThinIcon(props: PhSelectionThinIconProps) {
