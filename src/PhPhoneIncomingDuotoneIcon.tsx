...
export interface PhPhoneIncomingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneIncomingDuotoneIcon(props: PhPhoneIncomingDuotoneIconProps) {
