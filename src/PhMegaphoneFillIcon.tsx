...
export interface PhMegaphoneFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMegaphoneFillIcon(props: PhMegaphoneFillIconProps) {
