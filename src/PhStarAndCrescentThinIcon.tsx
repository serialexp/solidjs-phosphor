...
export interface PhStarAndCrescentThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStarAndCrescentThinIcon(props: PhStarAndCrescentThinIconProps) {
