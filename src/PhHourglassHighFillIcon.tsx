...
export interface PhHourglassHighFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassHighFillIcon(props: PhHourglassHighFillIconProps) {
