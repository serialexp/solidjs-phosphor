...
export interface PhNotificationBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNotificationBoldIcon(props: PhNotificationBoldIconProps) {
