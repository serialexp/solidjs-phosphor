...
export interface PhArrowsClockwiseThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowsClockwiseThinIcon(props: PhArrowsClockwiseThinIconProps) {
