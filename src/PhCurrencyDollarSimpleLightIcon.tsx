...
export interface PhCurrencyDollarSimpleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCurrencyDollarSimpleLightIcon(props: PhCurrencyDollarSimpleLightIconProps) {
