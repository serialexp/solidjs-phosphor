...
export interface PhArrowFatLinesUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLinesUpDuotoneIcon(props: PhArrowFatLinesUpDuotoneIconProps) {
