...
export interface PhFolderSimpleUserDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleUserDuotoneIcon(props: PhFolderSimpleUserDuotoneIconProps) {
