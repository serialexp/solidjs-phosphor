...
export interface PhChartLineUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartLineUpDuotoneIcon(props: PhChartLineUpDuotoneIconProps) {
