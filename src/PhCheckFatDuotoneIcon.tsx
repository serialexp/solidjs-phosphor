...
export interface PhCheckFatDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCheckFatDuotoneIcon(props: PhCheckFatDuotoneIconProps) {
