...
export interface PhChartLineFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChartLineFillIcon(props: PhChartLineFillIconProps) {
