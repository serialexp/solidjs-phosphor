...
export interface PhCalendarSlashLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarSlashLightIcon(props: PhCalendarSlashLightIconProps) {
