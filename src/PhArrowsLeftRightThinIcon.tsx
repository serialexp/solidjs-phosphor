...
export interface PhArrowsLeftRightThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowsLeftRightThinIcon(props: PhArrowsLeftRightThinIconProps) {
