...
export interface PhDetectiveThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDetectiveThinIcon(props: PhDetectiveThinIconProps) {
