...
export interface PhBellSimpleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBellSimpleLightIcon(props: PhBellSimpleLightIconProps) {
