...
export interface PhIntersectThreeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectThreeDuotoneIcon(props: PhIntersectThreeDuotoneIconProps) {
