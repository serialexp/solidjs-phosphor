...
export interface PhTrademarkRegisteredLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrademarkRegisteredLightIcon(props: PhTrademarkRegisteredLightIconProps) {
