...
export interface PhAmbulanceLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmbulanceLightIcon(props: PhAmbulanceLightIconProps) {
