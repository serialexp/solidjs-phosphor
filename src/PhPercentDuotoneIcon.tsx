...
export interface PhPercentDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPercentDuotoneIcon(props: PhPercentDuotoneIconProps) {
