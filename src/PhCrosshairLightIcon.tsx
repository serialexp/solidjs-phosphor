...
export interface PhCrosshairLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCrosshairLightIcon(props: PhCrosshairLightIconProps) {
