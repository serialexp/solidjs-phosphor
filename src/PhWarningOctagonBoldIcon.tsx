...
export interface PhWarningOctagonBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWarningOctagonBoldIcon(props: PhWarningOctagonBoldIconProps) {
