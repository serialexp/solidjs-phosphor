...
export interface PhLayoutDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhLayoutDuotoneIcon(props: PhLayoutDuotoneIconProps) {
