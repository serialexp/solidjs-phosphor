...
export interface PhFalloutShelterFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFalloutShelterFillIcon(props: PhFalloutShelterFillIconProps) {
