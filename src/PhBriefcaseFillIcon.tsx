...
export interface PhBriefcaseFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBriefcaseFillIcon(props: PhBriefcaseFillIconProps) {
