...
export interface PhNewspaperClippingIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNewspaperClippingIcon(props: PhNewspaperClippingIconProps) {
