...
export interface PhNyTimesLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNyTimesLogoFillIcon(props: PhNyTimesLogoFillIconProps) {
