...
export type { PhIconProps as PhWaveTriangleIconProps } from "./createIcon.js";
 ...
 */
export const PhWaveTriangleIcon = createIcon(`<path d="M238.48,132.68l-52,72a8,8,0,0,1-13,0L76,69.66l-45.51,63a8,8,0,1,1-13-9.36l52-72a8,8,0,0,1,13,0l97.51,135,45.51-63a8,8,0,1,1,13,9.36Z"/>`);
