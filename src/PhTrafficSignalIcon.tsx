...
export interface PhTrafficSignalIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrafficSignalIcon(props: PhTrafficSignalIconProps) {
