...
export type { PhIconProps as PhArrowArcLeftLightIconProps } from "./createIcon.js";
 ...
 */
export const PhArrowArcLeftLightIcon = createIcon(`<path d="M230,184a6,6,0,0,1-12,0A90,90,0,0,0,64.36,120.36L38.55,146H88a6,6,0,0,1,0,12H24a6,6,0,0,1-6-6V88a6,6,0,0,1,12,0v49.58l25.89-25.72A102,102,0,0,1,230,184Z"/>`);
