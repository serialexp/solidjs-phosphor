...
export interface PhHeartBreakDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHeartBreakDuotoneIcon(props: PhHeartBreakDuotoneIconProps) {
