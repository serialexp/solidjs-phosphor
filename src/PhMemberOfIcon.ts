...
export type { PhIconProps as PhMemberOfIconProps } from "./createIcon.js";
 ...
 */
export const PhMemberOfIcon = createIcon(`<path d="M200,136H56.46A72.08,72.08,0,0,0,128,200h72a8,8,0,0,1,0,16H128a88,88,0,0,1,0-176h72a8,8,0,0,1,0,16H128a72.08,72.08,0,0,0-71.54,64H200a8,8,0,0,1,0,16Z"/>`);
