...
export interface PhChatTeardropSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropSlashDuotoneIcon(props: PhChatTeardropSlashDuotoneIconProps) {
