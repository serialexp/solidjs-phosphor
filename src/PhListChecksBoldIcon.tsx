...
export interface PhListChecksBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListChecksBoldIcon(props: PhListChecksBoldIconProps) {
