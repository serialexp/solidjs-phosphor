...
export interface PhCalendarPlusBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarPlusBoldIcon(props: PhCalendarPlusBoldIconProps) {
