...
export interface PhSmileyAngryThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSmileyAngryThinIcon(props: PhSmileyAngryThinIconProps) {
