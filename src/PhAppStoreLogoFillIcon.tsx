...
export interface PhAppStoreLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAppStoreLogoFillIcon(props: PhAppStoreLogoFillIconProps) {
