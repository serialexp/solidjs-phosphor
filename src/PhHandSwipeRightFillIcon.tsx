...
export interface PhHandSwipeRightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeRightFillIcon(props: PhHandSwipeRightFillIconProps) {
