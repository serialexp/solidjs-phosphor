...
export interface PhBellSimpleSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBellSimpleSlashDuotoneIcon(props: PhBellSimpleSlashDuotoneIconProps) {
