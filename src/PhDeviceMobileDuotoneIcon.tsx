...
export interface PhDeviceMobileDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDeviceMobileDuotoneIcon(props: PhDeviceMobileDuotoneIconProps) {
