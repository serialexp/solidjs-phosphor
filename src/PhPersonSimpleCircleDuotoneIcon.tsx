...
export interface PhPersonSimpleCircleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPersonSimpleCircleDuotoneIcon(props: PhPersonSimpleCircleDuotoneIconProps) {
