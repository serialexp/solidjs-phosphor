...
export interface PhCalendarDotsThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarDotsThinIcon(props: PhCalendarDotsThinIconProps) {
