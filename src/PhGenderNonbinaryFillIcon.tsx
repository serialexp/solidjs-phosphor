...
export interface PhGenderNonbinaryFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGenderNonbinaryFillIcon(props: PhGenderNonbinaryFillIconProps) {
