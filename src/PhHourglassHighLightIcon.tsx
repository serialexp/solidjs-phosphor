...
export interface PhHourglassHighLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassHighLightIcon(props: PhHourglassHighLightIconProps) {
