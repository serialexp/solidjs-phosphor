...
export interface PhCalendarPlusFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarPlusFillIcon(props: PhCalendarPlusFillIconProps) {
