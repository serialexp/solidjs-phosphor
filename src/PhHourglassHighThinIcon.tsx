...
export interface PhHourglassHighThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassHighThinIcon(props: PhHourglassHighThinIconProps) {
