...
export interface PhHeartBreakThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHeartBreakThinIcon(props: PhHeartBreakThinIconProps) {
