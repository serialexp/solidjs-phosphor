...
export interface PhNyTimesLogoThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNyTimesLogoThinIcon(props: PhNyTimesLogoThinIconProps) {
