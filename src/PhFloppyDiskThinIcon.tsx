...
export interface PhFloppyDiskThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFloppyDiskThinIcon(props: PhFloppyDiskThinIconProps) {
