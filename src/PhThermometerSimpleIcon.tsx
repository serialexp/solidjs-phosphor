...
export interface PhThermometerSimpleIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerSimpleIcon(props: PhThermometerSimpleIconProps) {
