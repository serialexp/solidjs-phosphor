...
export interface PhCaretDoubleDownIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretDoubleDownIcon(props: PhCaretDoubleDownIconProps) {
