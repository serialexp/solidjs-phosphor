...
export interface PhAddressBookBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAddressBookBoldIcon(props: PhAddressBookBoldIconProps) {
