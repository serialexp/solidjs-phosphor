...
export interface PhTranslateBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTranslateBoldIcon(props: PhTranslateBoldIconProps) {
