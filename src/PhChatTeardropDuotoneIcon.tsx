...
export interface PhChatTeardropDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropDuotoneIcon(props: PhChatTeardropDuotoneIconProps) {
