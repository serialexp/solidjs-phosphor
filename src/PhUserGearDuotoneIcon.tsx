...
export interface PhUserGearDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserGearDuotoneIcon(props: PhUserGearDuotoneIconProps) {
