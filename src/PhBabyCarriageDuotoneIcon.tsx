...
export interface PhBabyCarriageDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBabyCarriageDuotoneIcon(props: PhBabyCarriageDuotoneIconProps) {
