...
export interface PhUserCirclePlusBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCirclePlusBoldIcon(props: PhUserCirclePlusBoldIconProps) {
