...
export interface PhChatTeardropDotsDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropDotsDuotoneIcon(props: PhChatTeardropDotsDuotoneIconProps) {
