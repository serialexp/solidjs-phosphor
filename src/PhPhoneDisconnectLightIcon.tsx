...
export interface PhPhoneDisconnectLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneDisconnectLightIcon(props: PhPhoneDisconnectLightIconProps) {
