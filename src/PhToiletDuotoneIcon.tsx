...
export interface PhToiletDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhToiletDuotoneIcon(props: PhToiletDuotoneIconProps) {
