...
export interface PhFolderSimpleUserThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFolderSimpleUserThinIcon(props: PhFolderSimpleUserThinIconProps) {
