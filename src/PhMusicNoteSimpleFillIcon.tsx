...
export interface PhMusicNoteSimpleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMusicNoteSimpleFillIcon(props: PhMusicNoteSimpleFillIconProps) {
