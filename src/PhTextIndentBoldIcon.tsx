...
export interface PhTextIndentBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextIndentBoldIcon(props: PhTextIndentBoldIconProps) {
