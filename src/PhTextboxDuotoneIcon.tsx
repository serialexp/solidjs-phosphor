...
export interface PhTextboxDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextboxDuotoneIcon(props: PhTextboxDuotoneIconProps) {
