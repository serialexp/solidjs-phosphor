...
export interface PhApplePodcastsLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhApplePodcastsLogoFillIcon(props: PhApplePodcastsLogoFillIconProps) {
