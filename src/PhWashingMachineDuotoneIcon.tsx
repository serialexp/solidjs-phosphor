...
export interface PhWashingMachineDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWashingMachineDuotoneIcon(props: PhWashingMachineDuotoneIconProps) {
