...
export interface PhUserListDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserListDuotoneIcon(props: PhUserListDuotoneIconProps) {
