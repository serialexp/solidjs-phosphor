...
export interface PhFunnelSimpleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFunnelSimpleFillIcon(props: PhFunnelSimpleFillIconProps) {
