...
export interface PhPhoneDisconnectBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneDisconnectBoldIcon(props: PhPhoneDisconnectBoldIconProps) {
