...
export interface PhAirplaneInFlightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneInFlightDuotoneIcon(props: PhAirplaneInFlightDuotoneIconProps) {
