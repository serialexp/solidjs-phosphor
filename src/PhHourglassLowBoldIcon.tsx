...
export interface PhHourglassLowBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHourglassLowBoldIcon(props: PhHourglassLowBoldIconProps) {
