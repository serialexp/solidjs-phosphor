...
export interface PhSuitcaseSimpleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSuitcaseSimpleLightIcon(props: PhSuitcaseSimpleLightIconProps) {
