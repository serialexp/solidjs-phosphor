...
export interface PhMicrosoftTeamsLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMicrosoftTeamsLogoIcon(props: PhMicrosoftTeamsLogoIconProps) {
