...
export interface PhPicnicTableFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPicnicTableFillIcon(props: PhPicnicTableFillIconProps) {
