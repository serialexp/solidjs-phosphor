...
export interface PhListNumbersLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListNumbersLightIcon(props: PhListNumbersLightIconProps) {
