...
export interface PhHamburgerDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHamburgerDuotoneIcon(props: PhHamburgerDuotoneIconProps) {
