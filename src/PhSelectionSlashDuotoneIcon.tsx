...
export interface PhSelectionSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSelectionSlashDuotoneIcon(props: PhSelectionSlashDuotoneIconProps) {
