...
export interface PhWalletDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWalletDuotoneIcon(props: PhWalletDuotoneIconProps) {
