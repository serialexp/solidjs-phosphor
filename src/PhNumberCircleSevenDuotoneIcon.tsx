...
export interface PhNumberCircleSevenDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleSevenDuotoneIcon(props: PhNumberCircleSevenDuotoneIconProps) {
