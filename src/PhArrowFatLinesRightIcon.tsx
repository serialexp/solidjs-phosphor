...
export interface PhArrowFatLinesRightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhArrowFatLinesRightIcon(props: PhArrowFatLinesRightIconProps) {
