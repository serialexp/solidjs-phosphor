...
export interface PhSoundcloudLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSoundcloudLogoIcon(props: PhSoundcloudLogoIconProps) {
