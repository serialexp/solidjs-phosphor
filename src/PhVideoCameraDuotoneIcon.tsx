...
export interface PhVideoCameraDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVideoCameraDuotoneIcon(props: PhVideoCameraDuotoneIconProps) {
