...
export interface PhTextHFiveDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHFiveDuotoneIcon(props: PhTextHFiveDuotoneIconProps) {
