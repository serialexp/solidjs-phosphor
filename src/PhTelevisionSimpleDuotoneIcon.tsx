...
export interface PhTelevisionSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTelevisionSimpleDuotoneIcon(props: PhTelevisionSimpleDuotoneIconProps) {
