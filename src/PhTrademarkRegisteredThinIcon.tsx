...
export interface PhTrademarkRegisteredThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrademarkRegisteredThinIcon(props: PhTrademarkRegisteredThinIconProps) {
