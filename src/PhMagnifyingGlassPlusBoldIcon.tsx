...
export interface PhMagnifyingGlassPlusBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhMagnifyingGlassPlusBoldIcon(props: PhMagnifyingGlassPlusBoldIconProps) {
