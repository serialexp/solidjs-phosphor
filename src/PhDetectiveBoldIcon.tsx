...
export interface PhDetectiveBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDetectiveBoldIcon(props: PhDetectiveBoldIconProps) {
