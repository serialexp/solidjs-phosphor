...
export interface PhHandSwipeRightLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHandSwipeRightLightIcon(props: PhHandSwipeRightLightIconProps) {
