...
export interface PhBatteryWarningIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBatteryWarningIcon(props: PhBatteryWarningIconProps) {
