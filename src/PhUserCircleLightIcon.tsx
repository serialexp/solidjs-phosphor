...
export interface PhUserCircleLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhUserCircleLightIcon(props: PhUserCircleLightIconProps) {
