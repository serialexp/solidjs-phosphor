...
export interface PhCellSignalSlashDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCellSignalSlashDuotoneIcon(props: PhCellSignalSlashDuotoneIconProps) {
