...
export interface PhColumnsPlusRightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhColumnsPlusRightDuotoneIcon(props: PhColumnsPlusRightDuotoneIconProps) {
