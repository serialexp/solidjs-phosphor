...
export interface PhPresentationChartThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPresentationChartThinIcon(props: PhPresentationChartThinIconProps) {
