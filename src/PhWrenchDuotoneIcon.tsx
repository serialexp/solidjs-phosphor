...
export interface PhWrenchDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhWrenchDuotoneIcon(props: PhWrenchDuotoneIconProps) {
