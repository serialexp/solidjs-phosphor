...
export interface PhSteamLogoFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSteamLogoFillIcon(props: PhSteamLogoFillIconProps) {
