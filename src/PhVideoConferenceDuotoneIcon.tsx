...
export interface PhVideoConferenceDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhVideoConferenceDuotoneIcon(props: PhVideoConferenceDuotoneIconProps) {
