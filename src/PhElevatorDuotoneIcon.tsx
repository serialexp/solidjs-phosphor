...
export interface PhElevatorDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhElevatorDuotoneIcon(props: PhElevatorDuotoneIconProps) {
