...
export interface PhTextHFiveFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHFiveFillIcon(props: PhTextHFiveFillIconProps) {
