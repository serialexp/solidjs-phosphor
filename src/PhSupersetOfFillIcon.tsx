...
export interface PhSupersetOfFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSupersetOfFillIcon(props: PhSupersetOfFillIconProps) {
