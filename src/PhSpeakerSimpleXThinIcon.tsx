...
export interface PhSpeakerSimpleXThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleXThinIcon(props: PhSpeakerSimpleXThinIconProps) {
