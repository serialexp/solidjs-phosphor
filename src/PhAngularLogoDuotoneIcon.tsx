...
export interface PhAngularLogoDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAngularLogoDuotoneIcon(props: PhAngularLogoDuotoneIconProps) {
