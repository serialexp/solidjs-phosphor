...
export interface PhListBulletsDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListBulletsDuotoneIcon(props: PhListBulletsDuotoneIconProps) {
