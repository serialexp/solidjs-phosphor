...
export interface PhSpeedometerLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeedometerLightIcon(props: PhSpeedometerLightIconProps) {
