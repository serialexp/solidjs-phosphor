...
export interface PhCookingPotLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCookingPotLightIcon(props: PhCookingPotLightIconProps) {
