...
export interface PhHouseSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHouseSimpleDuotoneIcon(props: PhHouseSimpleDuotoneIconProps) {
