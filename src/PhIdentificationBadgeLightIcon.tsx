...
export interface PhIdentificationBadgeLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeLightIcon(props: PhIdentificationBadgeLightIconProps) {
