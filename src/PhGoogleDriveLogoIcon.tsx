...
export interface PhGoogleDriveLogoIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhGoogleDriveLogoIcon(props: PhGoogleDriveLogoIconProps) {
