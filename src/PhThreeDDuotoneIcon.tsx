...
export interface PhThreeDDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThreeDDuotoneIcon(props: PhThreeDDuotoneIconProps) {
