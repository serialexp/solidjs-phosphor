...
export interface PhCalendarDotsFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCalendarDotsFillIcon(props: PhCalendarDotsFillIconProps) {
