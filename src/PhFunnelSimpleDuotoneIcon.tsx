...
export interface PhFunnelSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFunnelSimpleDuotoneIcon(props: PhFunnelSimpleDuotoneIconProps) {
