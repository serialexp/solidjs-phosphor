...
export interface PhHighHeelDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHighHeelDuotoneIcon(props: PhHighHeelDuotoneIconProps) {
