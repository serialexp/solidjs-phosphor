...
export interface PhNumberCircleSevenBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhNumberCircleSevenBoldIcon(props: PhNumberCircleSevenBoldIconProps) {
