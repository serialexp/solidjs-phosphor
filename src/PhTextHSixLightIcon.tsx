...
export interface PhTextHSixLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHSixLightIcon(props: PhTextHSixLightIconProps) {
