...
export interface PhPaperPlaneRightDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPaperPlaneRightDuotoneIcon(props: PhPaperPlaneRightDuotoneIconProps) {
