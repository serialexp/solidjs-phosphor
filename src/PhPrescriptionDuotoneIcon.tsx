...
export interface PhPrescriptionDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPrescriptionDuotoneIcon(props: PhPrescriptionDuotoneIconProps) {
