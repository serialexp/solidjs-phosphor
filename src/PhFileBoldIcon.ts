...
export type { PhIconProps as PhFileBoldIconProps } from "./createIcon.js";
 ...
 */
export const PhFileBoldIcon = createIcon(`<path d="M216.49,79.52l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40V216a20,20,0,0,0,20,20H200a20,20,0,0,0,20-20V88A12,12,0,0,0,216.49,79.52ZM160,57l23,23H160ZM60,212V44h76V92a12,12,0,0,0,12,12h48V212Z"/>`);
