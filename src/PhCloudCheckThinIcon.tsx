...
export interface PhCloudCheckThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCloudCheckThinIcon(props: PhCloudCheckThinIconProps) {
