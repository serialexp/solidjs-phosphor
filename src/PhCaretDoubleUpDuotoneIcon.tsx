...
export interface PhCaretDoubleUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretDoubleUpDuotoneIcon(props: PhCaretDoubleUpDuotoneIconProps) {
