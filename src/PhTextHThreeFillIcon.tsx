...
export interface PhTextHThreeFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTextHThreeFillIcon(props: PhTextHThreeFillIconProps) {
