...
export interface PhFileArrowUpDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileArrowUpDuotoneIcon(props: PhFileArrowUpDuotoneIconProps) {
