...
export interface PhTrolleySuitcaseDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrolleySuitcaseDuotoneIcon(props: PhTrolleySuitcaseDuotoneIconProps) {
