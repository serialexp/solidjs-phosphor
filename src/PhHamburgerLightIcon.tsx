...
export interface PhHamburgerLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhHamburgerLightIcon(props: PhHamburgerLightIconProps) {
