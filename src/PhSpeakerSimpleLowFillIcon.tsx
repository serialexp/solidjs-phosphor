...
export interface PhSpeakerSimpleLowFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSpeakerSimpleLowFillIcon(props: PhSpeakerSimpleLowFillIconProps) {
