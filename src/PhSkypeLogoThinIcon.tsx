...
export interface PhSkypeLogoThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhSkypeLogoThinIcon(props: PhSkypeLogoThinIconProps) {
