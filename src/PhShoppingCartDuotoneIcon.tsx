...
export interface PhShoppingCartDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhShoppingCartDuotoneIcon(props: PhShoppingCartDuotoneIconProps) {
