...
export interface PhPencilCircleFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPencilCircleFillIcon(props: PhPencilCircleFillIconProps) {
