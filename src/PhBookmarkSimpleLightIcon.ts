...
export type { PhIconProps as PhBookmarkSimpleLightIconProps } from "./createIcon.js";
 ...
 */
export const PhBookmarkSimpleLightIcon = createIcon(`<path d="M184,34H72A14,14,0,0,0,58,48V224a6,6,0,0,0,9.18,5.09l60.81-38,60.83,38A6,6,0,0,0,198,224V48A14,14,0,0,0,184,34Zm2,179.17-54.83-34.26a6,6,0,0,0-6.36,0L70,213.17V48a2,2,0,0,1,2-2H184a2,2,0,0,1,2,2Z"/>`);
