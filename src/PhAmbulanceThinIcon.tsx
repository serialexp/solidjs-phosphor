...
export interface PhAmbulanceThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAmbulanceThinIcon(props: PhAmbulanceThinIconProps) {
