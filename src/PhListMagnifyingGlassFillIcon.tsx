...
export interface PhListMagnifyingGlassFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhListMagnifyingGlassFillIcon(props: PhListMagnifyingGlassFillIconProps) {
