...
export interface PhThermometerColdBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhThermometerColdBoldIcon(props: PhThermometerColdBoldIconProps) {
