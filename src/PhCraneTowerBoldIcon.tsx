...
export interface PhCraneTowerBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCraneTowerBoldIcon(props: PhCraneTowerBoldIconProps) {
