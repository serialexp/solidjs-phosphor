...
export interface PhJoystickDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhJoystickDuotoneIcon(props: PhJoystickDuotoneIconProps) {
