...
export interface PhAirplaneTiltThinIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhAirplaneTiltThinIcon(props: PhAirplaneTiltThinIconProps) {
