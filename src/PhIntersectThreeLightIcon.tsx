...
export interface PhIntersectThreeLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIntersectThreeLightIcon(props: PhIntersectThreeLightIconProps) {
