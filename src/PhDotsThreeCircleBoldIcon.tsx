...
export interface PhDotsThreeCircleBoldIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDotsThreeCircleBoldIcon(props: PhDotsThreeCircleBoldIconProps) {
