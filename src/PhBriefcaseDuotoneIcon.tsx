...
export interface PhBriefcaseDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhBriefcaseDuotoneIcon(props: PhBriefcaseDuotoneIconProps) {
