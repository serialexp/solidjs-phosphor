...
export interface PhFileImageFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFileImageFillIcon(props: PhFileImageFillIconProps) {
