...
export interface PhColumnsPlusRightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhColumnsPlusRightFillIcon(props: PhColumnsPlusRightFillIconProps) {
