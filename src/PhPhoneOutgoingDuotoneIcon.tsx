...
export interface PhPhoneOutgoingDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhPhoneOutgoingDuotoneIcon(props: PhPhoneOutgoingDuotoneIconProps) {
