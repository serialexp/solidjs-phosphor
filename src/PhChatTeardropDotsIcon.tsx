...
export interface PhChatTeardropDotsIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhChatTeardropDotsIcon(props: PhChatTeardropDotsIconProps) {
