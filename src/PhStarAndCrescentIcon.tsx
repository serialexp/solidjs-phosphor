...
export interface PhStarAndCrescentIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhStarAndCrescentIcon(props: PhStarAndCrescentIconProps) {
