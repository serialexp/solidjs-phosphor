...
export interface PhTreeEvergreenLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTreeEvergreenLightIcon(props: PhTreeEvergreenLightIconProps) {
