...
export interface PhDatabaseLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDatabaseLightIcon(props: PhDatabaseLightIconProps) {
