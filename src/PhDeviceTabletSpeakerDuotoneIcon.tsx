...
export interface PhDeviceTabletSpeakerDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhDeviceTabletSpeakerDuotoneIcon(props: PhDeviceTabletSpeakerDuotoneIconProps) {
