...
export interface PhFishSimpleDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhFishSimpleDuotoneIcon(props: PhFishSimpleDuotoneIconProps) {
