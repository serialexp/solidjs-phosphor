...
export interface PhIdentificationBadgeDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhIdentificationBadgeDuotoneIcon(props: PhIdentificationBadgeDuotoneIconProps) {
