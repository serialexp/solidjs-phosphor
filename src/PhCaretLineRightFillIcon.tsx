...
export interface PhCaretLineRightFillIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhCaretLineRightFillIcon(props: PhCaretLineRightFillIconProps) {
