...
export interface PhTrafficSignalDuotoneIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhTrafficSignalDuotoneIcon(props: PhTrafficSignalDuotoneIconProps) {
