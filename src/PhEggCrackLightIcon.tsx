...
export interface PhEggCrackLightIconProps extends JSX.SvgSVGAttributes<SVGSVGElement> {
  size?: number | string;
  color?: string;
}
 ...
 */
export function PhEggCrackLightIcon(props: PhEggCrackLightIconProps) {
